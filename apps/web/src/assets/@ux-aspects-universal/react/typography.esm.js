...
function useTypographyStyles(_a) {
  var {
    ...
    otherProps = __rest(_a, ["color", "fontSize", "fontWeight", "style"]);
  style = mergeProps({
    color,
    fontSize,
    fontWeight
...
const InlineText = forwardRef((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["is", "size", "children"]);
