...
const AppContentLayout = _a => {
  var {
    ...
    props = __rest(_a, ["secondaryMasthead", "sideNavigation", "children"]);
...
const AppLayout = _a => {
  var {
    ...
    props = __rest(_a, ["masthead", "secondaryMasthead", "sideNavigation", "alerts", "children"]);
  return React.createElement("div", Object.assign({}, mergeProps({
