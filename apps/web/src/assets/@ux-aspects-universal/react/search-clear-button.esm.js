...
const InputGroup = forwardRef((_a, ref) => {
  var {
    ...
    htmlProps = __rest(_a, ["size", "isDisabled", "leadingAddon", "trailingAddon", "children"]);
