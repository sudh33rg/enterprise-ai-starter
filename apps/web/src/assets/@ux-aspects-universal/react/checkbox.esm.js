...
const Checkbox = forwardRef((props, ref) => {
  ...
  const {
    ...
    htmlProps = __rest(props, ["id", "className", "style", "defaultChecked", "checked", "isChecked", "isIndeterminate", "isDisabled", "isReadonly", "onCheckedChange", "children", "name", "inert", "value"]);
  ...
  const {
    wrapperId,
    inputId
  } = useWrappedInputId(id, 'uxa-checkbox');
...
const CheckboxGroup = forwardRef((_a, ref) => {
  var {
    ...
    htmlProps = __rest(_a, ["children", "orientation", "isDisabled", "isReadonly", "name", "density", "value", "onValueChange"]);
