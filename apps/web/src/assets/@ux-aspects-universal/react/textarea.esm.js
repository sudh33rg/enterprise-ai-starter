...
const TextInput = forwardRef((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["className", "size", "type", "isDisabled", "isReadonly", "value", "onValueChange", "defaultValue"]);
...
const TextArea = React.forwardRef((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["isDisabled", "onValueChange"]);
