...
const RangeHandle = forwardRef((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["isActive", "isDisabled", "isHovered"]);
...
const SliderTicks = ({
  ...
  const {
    rect: sliderRect
  } = useElementRect(slider);
  const {
    rect: tickRect
  } = useElementRect(tickRef);
...
const RangeSlider = forwardRef((_a, ref) => {
  var {
    ...
    htmlProps = __rest(_a, ["isDisabled", "ariaLabelLow", "ariaLabelHigh", "ariaLabelledbyLow", "ariaLabelledbyHigh", "low", "high", "min", "max", "ticks", "tooltip", "lowTooltipRender", "highTooltipRender", "onLowChange", "onHighChange"]);
  ...
  const _b = useSliderThumb({
    ...
    }),
    {
      ...
      style: styleLow,
      isDragging: isDraggingLow,
      isFocusVisible: isFocusVisibleLow
    } = _b,
    lowThumbProps = __rest(_b, ["onMouseDown", "style", "isDragging", "isFocusVisible"]);
  const _c = useSliderThumb({
    ...
    }),
    {
      ...
      style: styleHigh,
      isDragging: isDraggingHigh,
      isFocusVisible: isFocusedVisibleHigh
    } = _c,
    highThumbProps = __rest(_c, ["onMouseDown", "style", "isDragging", "isFocusVisible"]);
  useEffect(() => {
...
const Slider = forwardRef((_a, ref) => {
  var {
    ...
    htmlProps = __rest(_a, ["id", "isDisabled", "defaultValue", "value", "min", "max", "tooltip", "ticks", 'aria-describedby', 'aria-label', 'aria-labelledby', "tooltipRender", "onValueChange"]);
  const sliderRef = useRef(null);
  const sliderContainerRef = useRef(null);
  ...
  const {
    wrapperId,
    inputId
  } = useWrappedInputId(id, 'uxa-slider');
  const direction = useDirection();
  useSliderTrack({
    ref: sliderRef,
    min,
  ...
  const _b = useSliderThumb({
    ...
    thumbProps = __rest(_b, ["onMouseDown", "style"]);
  const percentage = usePercentage(value, min, max);
  const {
    inputHtmlProps,
    wrapperHtmlProps
