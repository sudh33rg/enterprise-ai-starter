const jatoDark = {
  ...
  jatoAvatarBorderColorHover: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A015)}`;
  },
  ...
  jatoBackgroundBase: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0080)}`;
  },
  ...
  jatoBackgroundElevationGradientControlLevel0: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0050A000)}`;
  },
  jatoBackgroundElevationGradientControlLevel1: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0110A000)}`;
  },
  jatoBackgroundElevationGradientControlLevel2: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0110A000)}`;
  },
  jatoBackgroundElevationGradientControlLevel3: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0165A000)}`;
  },
  jatoBackgroundElevationGradientControlLevel4: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0165A000)}`;
  },
  jatoBackgroundElevationInlineContent: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A008)}`;
  },
  jatoBackgroundElevationLevel0: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0050)}`;
  },
  ...
  jatoBackgroundElevationLevel2Active: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A010)}`;
  },
  ...
  jatoBackgroundElevationLevel3: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0165)}`;
  },
  jatoBackgroundElevationLevel4: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0165)}`;
  },
  jatoBackgroundErrorActive: props => {
    return `${resolveValue(props, props.theme.jatoColorFirebrick0205)}`;
  },
  jatoBackgroundErrorHover: props => {
    return `${resolveValue(props, props.theme.jatoColorFirebrick0080)}`;
  },
  jatoBackgroundErrorNeutral: props => {
    return `${resolveValue(props, props.theme.jatoColorFirebrick0055)}`;
  },
  jatoBackgroundMaskArea: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0275A065)}`;
  },
  jatoBackgroundMaskAreaStrong: props => {
    return `${resolveValue(props, props.theme.jatoColorBlack0000A080)}`;
  },
  jatoBackgroundMaskPage: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0275A065)}`;
  },
  jatoBackgroundRowsActive: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A020)}`;
  },
  jatoBackgroundRowsAlternate: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel2390A015)}`;
  },
  ...
  jatoBackgroundRowsNew: props => {
    return `${resolveValue(props, props.theme.jatoColorHunter0180)}`;
  },
  jatoBackgroundRowsSelected: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A015)}`;
  },
  jatoBackgroundSuccessActive: props => {
    return `${resolveValue(props, props.theme.jatoColorHunter0545)}`;
  },
  ...
  jatoBackgroundTextHighlight: props => {
    return `${resolveValue(props, props.theme.jatoColorPlum1210A070)}`;
  },
  ...
  jatoBorderColorPrimaryHover: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A030)}`;
  },
  ...
  jatoControlBackgroundReadOnlyActive: props => {
    return `${resolveValue(props, props.theme.jatoColorNavy0500)}`;
  },
  ...
  jatoControlBorderPrimaryNeutralLight: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel1750)}`;
  },
  ...
  jatoControlMvAddNeutral: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A080)}`;
  },
  ...
  jatoControlMvClearEnabled: props => {
    return `${resolveValue(props, props.theme.jatoColorFirebrick4310)}`;
  },
  ...
  jatoControlSymbolColorActive: props => {
    return `${resolveValue(props, props.theme.jatoColorNavy6385)}`;
  },
  jatoControlSymbolColorHover: props => {
    return `${resolveValue(props, props.theme.jatoColorNavy3855)}`;
  },
  jatoControlSymbolColorSelectedActive: props => {
    return `${resolveValue(props, props.theme.jatoColorBlack0000A070)}`;
  },
  ...
  jatoElevationShadowColorLevel1: props => {
    return `${resolveValue(props, props.theme.jatoColorBlack0000A032)}`;
  },
  ...
  jatoInputBorderContainerErrorNeutral: props => {
    return `${resolveValue(props, props.theme.jatoColorFirebrick0675)}`;
  },
  ...
  jatoInputBorderFocusNeutral: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A050)}`;
  },
  ...
  jatoMessagesInlineBackgroundInformation: props => {
    return `${resolveValue(props, props.theme.jatoColorBlue0165)}`;
  },
  jatoMessagesInlineBackgroundSuccess: props => {
    return `${resolveValue(props, props.theme.jatoColorHunter0545)}`;
  },
  jatoMessagesInlineBackgroundWarning: props => {
    return `${resolveValue(props, props.theme.jatoColorAmber0485)}`;
  },
  ...
  jatoMessagesInlineBorderGradientWarning: props => {
    return `${resolveValue(props, props.theme.jatoColorAmber1750)}`;
  },
  jatoMessagesInlineBorderInformation: props => {
    return `${resolveValue(props, props.theme.jatoColorBlue2395)}`;
  },
  ...
  jatoMessagesInlineIconFillInformation: props => {
    return `${resolveValue(props, props.theme.jatoColorBlue4705)}`;
  },
  ...
  jatoNotificationsUnreadIndicatorBorder: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel0275)}`;
  },
  ...
  jatoTagsBackgroundNew: props => {
    return `${resolveValue(props, props.theme.jatoColorBlue0330)}`;
  },
  jatoTagsFormatThumbnailBackground: props => {
    return `${resolveValue(props, props.theme.jatoColorWhite10000A060)}`;
  },
  ...
  jatoGraphBackgroundChart: 'rgba(39, 45, 71, 1)',
  jatoGraphBorderAxisLines: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel8595)}`;
  },
  jatoGraphBorderChartOutline: 'rgba(36, 41, 63, 1)',
  ...
  jatoMeaningfulColor2VeryHigh: 'rgba(255, 64, 96, 1)',
  jatoQualitative01: 'rgba(117, 138, 255, 1)',
  jatoQualitative02: 'rgba(45, 232, 213, 1)',
  jatoQualitative03: props => {
    return `${resolveValue(props, props.theme.jatoColorRaspberry4520)}`;
  },
  jatoQualitative04: 'rgba(189, 167, 255, 1)',
  jatoQualitative05: 'rgba(247, 198, 2, 1)',
  jatoQualitative06: props => {
    return `${resolveValue(props, props.theme.jatoColorGreen5220)}`;
  },
  jatoQualitative07: props => {
    return `${resolveValue(props, props.theme.jatoColorBlue4705)}`;
  },
  jatoQualitative08: 'rgba(255, 185, 177, 1)',
  jatoQualitative09: props => {
    return `${resolveValue(props, props.theme.jatoColorCerulean7600)}`;
  },
  jatoQualitative10: props => {
    return `${resolveValue(props, props.theme.jatoColorPlum6280)}`;
  },
  jatoQualitative11: props => {
    return `${resolveValue(props, props.theme.jatoColorFirebrick4310)}`;
  },
  jatoQualitative12: props => {
    return `${resolveValue(props, props.theme.jatoColorAmber8295)}`;
  },
  jatoQualitative13: props => {
    return `${resolveValue(props, props.theme.jatoColorTeal7425)}`;
  },
  jatoQualitative14: props => {
    return `${resolveValue(props, props.theme.jatoColorAmber5490)}`;
  },
  jatoQualitative15: props => {
    return `${resolveValue(props, props.theme.jatoColorGreen8880)}`;
  },
  jatoQualitative16: props => {
    return `${resolveValue(props, props.theme.jatoColorCerulean6200)}`;
  },
  jatoQualitative17: props => {
    return `${resolveValue(props, props.theme.jatoColorRaspberry7215)}`;
  },
  jatoQualitative18: props => {
    return `${resolveValue(props, props.theme.jatoColorNavy3855)}`;
  },
  jatoQualitative19: props => {
    return `${resolveValue(props, props.theme.jatoColorCharcoal4620)}`;
  },
  jatoQualitative20: 'rgba(255, 252, 252, 1)',
  jatoStatusRating01: 'rgba(229, 0, 77, 1)',
  jatoStatusRating02: 'rgba(255, 64, 96, 1)',
  jatoStatusRating03: props => {
    return `${resolveValue(props, props.theme.jatoColorAmber4425)}`;
  },
  jatoStatusRating04: props => {
    return `${resolveValue(props, props.theme.jatoColorDiscovery6440)}`;
  },
  ...
  jatoStatusRating10: props => {
    return `${resolveValue(props, props.theme.jatoColorNavy6385)}`;
  },
  jatoStatusRating11: props => {
    return `${resolveValue(props, props.theme.jatoColorSteel4630)}`;
  },
  checkboxTickBackgroundImageHover: 'url("data:image/svg+xml;base64,")',
  checkboxTickBackgroundImageActive: 'url("data:image/svg+xml;base64,")',
  checkboxTickBackgroundImageChecked: 'url("data:image/svg+xml;base64,")',
  checkboxTickBackgroundImageCheckedHover: 'url("data:image/svg+xml;base64,")',
  ...
  checkboxTickBackgroundImageCheckedReadonly: 'url("data:image/svg+xml;base64,")',
  checkboxTickBackgroundImageCheckedDisabled: 'url("data:image/svg+xml;base64,")',
  checkboxTickBackgroundImageIndeterminate: 'url("data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iOCIgaGVpZ2h0PSIyIiB2aWV3Qm94PSIwIDAgOCAyIiBmaWxsPSJub25lIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgo8cmVjdCB3aWR0aD0iOCIgaGVpZ2h0PSIxLjI1IiByeD0iMC42MjUiIGZpbGw9IiMwMDAiLz4KPC9zdmc+Cg==")',
  checkboxTickBackgroundImageIndeterminateHover: 'url("data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iOCIgaGVpZ2h0PSIyIiB2aWV3Qm94PSIwIDAgOCAyIiBmaWxsPSJub25lIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgo8cmVjdCB3aWR0aD0iOCIgaGVpZ2h0PSIxLjI1IiByeD0iMC42MjUiIGZpbGw9IiMwMDAwMDBiMyIvPgo8L3N2Zz4K")',
  ...
  checkboxTickBackgroundImageIndeterminateDisabled: 'url("data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iOCIgaGVpZ2h0PSIyIiB2aWV3Qm94PSIwIDAgOCAyIiBmaWxsPSJub25lIiB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciPgo8cmVjdCB3aWR0aD0iOCIgaGVpZ2h0PSIxLjI1IiByeD0iMC42MjUiIGZpbGw9IiM1ZjYxNjMiLz4KPC9zdmc+Cg==")',
  chipBackgroundColorReadonly: '#1d294d',
  breadcrumbSeparatorBackgroundImage: 'url("data:image/svg+xml;base64,")',
  formFieldFeedbackBackgroundError: props => {
    return `color-mix(
    in srgb,
    ${resolveValue(props, props.theme.jatoMessagesInlineBackgroundError)} 64%,
    transparent
  )`;
  },
  formFieldFeedbackBackgroundSuccess: props => {
    return `color-mix(
    in srgb,
    ${resolveValue(props, props.theme.jatoMessagesInlineBackgroundSuccess)} 64%,
    transparent
  )`;
  },
  inlineNotificationBackgroundColorInfo: props => {
    return `color-mix(
    in srgb,
    ${resolveValue(props, props.theme.jatoMessagesInlineBackgroundInformation)} 64%,
    transparent
  )`;
  },
  inlineNotificationBackgroundColorWarning: props => {
    return `color-mix(
    in srgb,
    ${resolveValue(props, props.theme.jatoMessagesInlineBackgroundWarning)} 64%,
    transparent
  )`;
  },
  ...
  loginPanelBackgroundColor: '#2a2f45bf',
  multiValueChipBackgroundReadonly: '#1d294d',
  multiValueChipBackgroundReadonlyHover: '#212b47',
  multiValueChipBackgroundReadonlyActive: '#1f2944',
  ...
  tableCellBackgroundColorOddStripedHover: '#2f3d5c',
  treeChildBackgroundColorSelected: 'rgba(255, 255, 255, 0.08)',
  treeChildBackgroundColorSelectedHover: 'rgba(255, 255, 255, 0.1)'
};
