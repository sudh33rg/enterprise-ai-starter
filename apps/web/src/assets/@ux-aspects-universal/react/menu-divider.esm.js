...
const Menu = _a => {
  ...
  var {
    ...
    props = __rest(_a, ["isOpen", "onClose", "placement", "alignment", "hasArrow", "triggerRef", "anchorRef", "offsetX", "offsetY", "closeOnBlur", "children"]);
  const {
    isJato
  } = useThemeFamily();
  ...
  useIsomorphicEffect(() => {
    ...
    const {
      arrowBgStyle: bgStyle,
      arrowFgStyle: fgStyle
    } = getArrowPosition(triggerRef.current, menuRef.current, arrowBg.current, arrowFg.current, placement, alignment);
...
const SubMenu = _a => {
  var {
    ...
    props = __rest(_a, ["isOpen", "onClose", "triggerRef", "children"]);
  const menuRef = useRef(null);
...
const MenuItem = _a => {
  var {
    ...
    props = __rest(_a, ["icon", "isDisabled", "subMenu", "children"]);
  const {
    buttonProps,
    subMenuProps,
    subMenuProviderProps
...
const MenuToggleItem = _a => {
  var {
    ...
    props = __rest(_a, ["controlType", "isChecked", "isDisabled", "onCheckedChange", "children"]);
