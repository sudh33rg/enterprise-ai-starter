...
function useNumberPicker(_a) {
  var {
    ...
    props = __rest(_a, ["id", "className", "style", "defaultValue", "value", "step", "min", "max", "onChange", "onValueChange", "isDisabled", "isInvalid", "stepperType", "size", "title"]);
  ...
  const {
    wrapperId,
    inputId
  } = useWrappedInputId(id, 'uxa-number-picker');
...
const StepButton = _a => {
  var {
    ...
    props = __rest(_a, ["direction", "isDisabled", "stepperType"]);
  let icon;
  switch (direction) {
    case 'up':
