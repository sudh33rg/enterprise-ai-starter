...
const Chip = forwardRef((_a, ref) => {
  var {
    ...
    htmlProps = __rest(_a, ["size", "isSelectable", "isSelected", "onSelectedChange", "isRemovable", "onRemove", "isDisabled", "isReadonly", "children", "icon"]);
  const {
    isFocusVisible,
    focusProps
  } = useFocusRing();
...
const ChipAvatar = forwardRef((_a, ref) => {
  var {
    ...
    htmlProps = __rest(_a, ["image", "color"]);
  const {
    isDisabled
  } = useChipContext();
...
const MultiValueChip = forwardRef((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["label", "isExpanded", "values", "isReadonly", "isDisabled", "onExpandedChange", "onValuesChange"]);
