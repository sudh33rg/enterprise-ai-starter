...
function useFocusableRef({ id, disabled, ref, isFocused, value }) {
    return useMemo(() => ({
        id,
        disabled,
        ref,
...
function useTabbable(ref, { id, isDisabled, value } = {}) {
    const { addItem, removeItem, setActiveItem, focusFirst, focusLast, focusNext, focusPrevious, orientation, setDisabled, focusBelow, focusAbove, onFocusItemChange } = useFocusManager();
