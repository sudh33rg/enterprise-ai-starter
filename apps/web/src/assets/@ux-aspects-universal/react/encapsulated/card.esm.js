...
var css_248z = ":host:not(#\\9):not(#\\9):not(#\\9),\n:not(#\\9):not(#\\9):not(#\\9) .uxa-card-footer {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-stacked,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-card-footer.uxa-stacked {\n  flex-direction: column;\n  gap: var(--uxa-card-footer__gap--stacked);\n}\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-stacked .uxa-card-footer-leading,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-stacked .uxa-card-footer-trailing,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-card-footer.uxa-stacked .uxa-card-footer-leading,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-card-footer.uxa-stacked .uxa-card-footer-trailing {\n  width: 100%;\n}\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-stacked .uxa-card-footer-trailing,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-card-footer.uxa-stacked .uxa-card-footer-trailing {\n  justify-content: flex-end;\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-card-footer-leading {\n  display: flex;\n  gap: var(--uxa-card-footer-leading__gap);\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-card-footer-trailing {\n  display: flex;\n  gap: var(--uxa-card-footer-trailing__gap);\n}";
styleInject(css_248z);
const CardFooter = forwardRef((_a, ref) => {
    var { isStacked, leading, trailing } = _a, props = __rest(_a, ["isStacked", "leading", "trailing"]);
    return React.createElement("div", Object.assign({
        ref: ref
    }, mergeProps({
