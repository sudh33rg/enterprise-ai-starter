...
const RadioButton = forwardRef((props, ref) => {
    ...
    const { inputProps } = useRadio(radioButtonProps, state, inputRef);
    const { isFocusVisible, focusProps } = useFocusRing();
    const isSelected = state.selectedValue === value;
    const { wrapperId, inputId } = useWrappedInputId(id, "uxa-radio-button");
...
var css_248z = ":not(#\\9):not(#\\9):not(#\\9) .uxa-radio-button-group,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-radio-button-group {\n  display: flex;\n  flex-direction: column;\n  width: -moz-max-content;\n  width: max-content;\n  gap: var(--uxa-radio-button-group__gap);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-radio-button-group.uxa-radio-button-group-horizontal,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-radio-button-group.uxa-radio-button-group-horizontal {\n  flex-direction: row;\n  --uxa-radio-button-group__gap: var(--uxa-radio-button-group__gap--horizontal);\n  --uxa-radio-button-group__gap--compact: var(--uxa-radio-button-group__gap--horizontal--compact);\n  --uxa-radio-button-group__gap--spacious: var(\n    --uxa-radio-button-group__gap--horizontal--spacious\n  );\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-radio-button-group.uxa-compact,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-radio-button-group.uxa-compact {\n  gap: var(--uxa-radio-button-group__gap--compact);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-radio-button-group.uxa-spacious,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-radio-button-group.uxa-spacious {\n  gap: var(--uxa-radio-button-group__gap--spacious);\n}";
styleInject(css_248z);
const RadioGroup = forwardRef((props, ref) => {
    const { children, orientation = "vertical", density = "regular", onValueChange, onChange, isDisabled = false, isReadonly = false } = props, htmlProps = __rest(props, ["children", "orientation", "density", "onValueChange", "onChange", "isDisabled", "isReadonly"]);
    const state = useRadioGroupState(Object.assign(Object.assign({}, props), {
        onChange: onValueChange,
        isDisabled,
        isReadOnly: isReadonly
    }));
    const { radioGroupProps } = useRadioGroup(mergeProps(props, {
        onChange: onValueChange
    }), state);
