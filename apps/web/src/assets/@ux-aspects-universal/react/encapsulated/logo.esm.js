...
function useLogoProps(_a) {
    var { width, height, style, label } = _a, props = __rest(_a, ["width", "height", "style", "label"]);
...
const OpentextLogo = forwardRef((_a, ref) => {
    var { width, height, label = "OpenText" } = _a, props = __rest(_a, ["width", "height", "label"]);
    const { logoProps, titleId, style } = useLogoProps(Object.assign({
        width,
        height,
        label
    }, props));
...
const OpentextLoginLogo = forwardRef((_a, ref) => {
    var { width = "189px", height = "31px", label = "OpenText" } = _a, props = __rest(_a, ["width", "height", "label"]);
    const { logoProps, titleId, style } = useLogoProps(Object.assign({
        width,
        height,
        label
...
const OpentextSmallLogo = forwardRef((_a, ref) => {
    var { width = "26px", height = "20px", label = "OpenText" } = _a, props = __rest(_a, ["width", "height", "label"]);
    const { logoProps, titleId, style } = useLogoProps(Object.assign({
        width,
        height,
        label
