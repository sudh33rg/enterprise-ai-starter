...
function useSelect({ id, ariaLabelledBy, value, onValueChange, onChange, isOpen, onOpenChange, dropdownPlacement, isDisabled, onPress, onClose, onSelectOption, maxHeight, displayWith, controllerRef, defaultValue, children, clearable, panelWidth, onScrolledToEnd }) {
    var _a;
...
var css_248z$2 = "/** Wire up variables for the four sides of `margin`. Uses logical properties for the inline dimension. */\n/** Wire up variables for the inline dimension of `margin`, using logical properties. */\n/** Wire up variables for the four sides of `padding`. Uses logical properties for the inline dimension. */\n/** Wire up variables for the inline dimension of `padding`, using logical properties. */\n/** Wire up segments for the logical dimensions of `border-radius`. */\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox {\n  display: flex;\n  align-items: center;\n  box-sizing: border-box;\n  cursor: pointer;\n  height: var(--uxa-select__height);\n  border-style: var(--uxa-select__border-style);\n  border-width: var(--uxa-select__border-width);\n  border-color: var(--uxa-select__border-color);\n  border-radius: var(--uxa-select__border-radius);\n  padding-inline: var(--uxa-select__padding-inline);\n  background-color: var(--uxa-select__background-color);\n  font-family: var(--uxa-select__font-family, var(--uxa-typography__font-family));\n  font-size: var(--uxa-select__font-size);\n  width: var(--uxa-select__width, 100%);\n  -moz-column-gap: var(--uxa-select__column-gap);\n       column-gap: var(--uxa-select__column-gap);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-small,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-small,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-small,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-small {\n  height: var(--uxa-select__height--small);\n  padding-inline: var(--uxa-select__padding-inline--small);\n  border-radius: var(--uxa-select__border-radius--small);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-large,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-large,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-large,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-large {\n  height: var(--uxa-select__height--large);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select:focus:not(.uxa-disabled), :not(#\\9):not(#\\9):not(#\\9) .uxa-select:focus-within:not(.uxa-disabled), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-select:focus:not(.uxa-disabled), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-select:focus-within:not(.uxa-disabled), :not(#\\9):not(#\\9):not(#\\9) .uxa-combobox:focus:not(.uxa-disabled), :not(#\\9):not(#\\9):not(#\\9) .uxa-combobox:focus-within:not(.uxa-disabled), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox:focus:not(.uxa-disabled), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox:focus-within:not(.uxa-disabled) {\n  outline: none;\n  border-color: var(--uxa-select__border-color--focused);\n  box-shadow: var(--uxa-select__box-shadow--focused);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-focused,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-focused,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-focused,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-focused {\n  border-color: var(--uxa-select__border-color--focused);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select:hover:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select:hover:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox:hover:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox:hover:not(.uxa-disabled) {\n  border-color: var(--uxa-select__border-color--hover);\n  background-color: var(--uxa-select__background-color--hover);\n  box-shadow: var(--uxa-select__box-shadow--hover);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select:hover:not(.uxa-disabled) .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select:hover:not(.uxa-disabled) .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox:hover:not(.uxa-disabled) .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox:hover:not(.uxa-disabled) .uxa-select-value {\n  color: var(--uxa-select-value__color--hover);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select:hover:not(.uxa-disabled) .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select:hover:not(.uxa-disabled) .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox:hover:not(.uxa-disabled) .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox:hover:not(.uxa-disabled) .uxa-select-arrow {\n  color: var(--uxa-select-arrow__color--hover);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select:active:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select:active:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox:active:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox:active:not(.uxa-disabled) {\n  background-color: var(--uxa-select__background-color--active);\n  border-color: var(--uxa-select__border-color--active);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select:active:not(.uxa-disabled) .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select:active:not(.uxa-disabled) .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox:active:not(.uxa-disabled) .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox:active:not(.uxa-disabled) .uxa-select-value {\n  color: var(--uxa-select-value__color--active);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select:active:not(.uxa-disabled) .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select:active:not(.uxa-disabled) .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox:active:not(.uxa-disabled) .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox:active:not(.uxa-disabled) .uxa-select-arrow {\n  color: var(--uxa-select-arrow__color--active);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-invalid,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-invalid,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-invalid,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-invalid {\n  border-color: var(--uxa-select__border-color--invalid);\n  background-color: var(--uxa-select__background-color--invalid);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-invalid:hover:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-invalid:hover:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-invalid:hover:not(.uxa-disabled),\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-invalid:hover:not(.uxa-disabled) {\n  background-color: var(--uxa-select__background-color--hover-invalid);\n  box-shadow: var(--uxa-select__box-shadow--hover-invalid);\n  border-color: var(--uxa-select__border-color--hover-invalid);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-expanded,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-expanded,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-expanded,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-expanded {\n  border-color: var(--uxa-select__border-color--expanded);\n  box-shadow: var(--uxa-select__box-shadow--expanded);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-disabled,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-disabled,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-disabled,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-disabled {\n  border-color: var(--uxa-select__border-color--disabled);\n  background-color: var(--uxa-select__background-color--disabled);\n  cursor: default;\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-disabled .uxa-select-placeholder,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-disabled .uxa-select-placeholder,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-disabled .uxa-select-placeholder,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-disabled .uxa-select-placeholder {\n  color: var(--uxa-select-placeholder__color--disabled);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-disabled .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-disabled .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-disabled .uxa-select-value,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-disabled .uxa-select-value {\n  color: var(--uxa-select-value__color--disabled);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select.uxa-disabled .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select.uxa-disabled .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-disabled .uxa-select-arrow,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-disabled .uxa-select-arrow {\n  color: var(--uxa-select-arrow__color--disabled);\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select input[type=text],\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-select input[type=text] {\n  display: none;\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-placeholder {\n  flex: 1;\n  color: var(--uxa-select-placeholder__color);\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-value {\n  flex: 1;\n  font-size: var(--uxa-select-value__font-size, inherit);\n  font-weight: var(--uxa-select-value__font-weight, inherit);\n  color: var(--uxa-select-value__color);\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-arrow {\n  min-width: var(--uxa-select-arrow__min-width);\n  font-size: var(--uxa-select-arrow__font-size, inherit);\n  color: var(--uxa-select-arrow__color);\n  box-sizing: border-box;\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-option-panel {\n  display: flex;\n  flex-direction: column;\n  max-height: var(--uxa-select-option-panel__max-height);\n  margin-inline: var(--uxa-select-option-panel__margin-inline);\n  margin-block: var(--uxa-select-option-panel__margin-block);\n  box-shadow: var(--uxa-select-option-panel__box-shadow);\n  border: var(--uxa-select-option-panel__border);\n  border-radius: var(--uxa-select-option-panel__border-radius);\n  background-color: var(--uxa-select-option-panel__background-color);\n  padding-inline: var(--uxa-select-option-panel__padding-inline);\n  padding-block: var(--uxa-select-option-panel__padding-block);\n  gap: var(--uxa-select-option-panel__gap);\n  overflow-y: auto;\n  box-sizing: border-box;\n  width: 100%;\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox {\n  display: inline-flex;\n  box-sizing: border-box;\n  padding-inline: 0;\n  padding-block: 0;\n  --uxa-text-input__border: none;\n  --uxa-text-input__height: 100%;\n  --uxa-text-input__border--disabled: none;\n  --uxa-text-input__border--focused: none;\n  --uxa-text-input__border--hover: none;\n  --uxa-text-input__background-color: transparent;\n  --uxa-text-input__background-color--disabled: transparent;\n  --uxa-text-input__background-color--hover: transparent;\n  --uxa-text-input__box-shadow--hover: none;\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-combobox-text-input,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-combobox-text-input {\n  font-family: var(--uxa-text-input__font-family, var(--uxa-typography__font-family));\n  font-weight: var(--uxa-text-input__font-weight);\n  font-size: var(--uxa-text-input__font-size);\n  color: var(--uxa-text-input__color);\n  background-color: var(--uxa-text-input__background-color);\n  padding-inline: var(--uxa-text-input__padding-inline);\n  padding-block-start: var(--uxa-text-input__padding-block-start);\n  padding-block-end: var(--uxa-text-input__padding-block-end);\n  height: var(--uxa-text-input__height);\n  width: var(--uxa-text-input__width);\n  border-style: var(--uxa-text-input__border-style);\n  border-width: var(--uxa-text-input__border-width);\n  border-color: var(--uxa-text-input__border-color);\n  border-radius: var(--uxa-text-input__border-radius);\n  box-sizing: border-box;\n  border: none;\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-combobox-text-input::-moz-placeholder, :not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-combobox-text-input::-moz-placeholder {\n  color: var(--uxa-text-input-placeholder__color);\n  font-weight: var(--uxa-text-input-placeholder__font-weight);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-combobox-text-input::placeholder,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-combobox-text-input::placeholder {\n  color: var(--uxa-text-input-placeholder__color);\n  font-weight: var(--uxa-text-input-placeholder__font-weight);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-combobox-text-input:focus,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-combobox-text-input:focus {\n  outline: none;\n  border-color: var(--uxa-text-input__border-color--focused);\n  box-shadow: var(--uxa-text-input__box-shadow--focused);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-combobox-text-input:hover:not(:disabled),\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-combobox-text-input:hover:not(:disabled) {\n  border-color: var(--uxa-text-input__border-color--hover);\n  background-color: var(--uxa-text-input__background-color--hover);\n  box-shadow: var(--uxa-text-input__box-shadow--hover);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-combobox-text-input.uxa-invalid,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-combobox-text-input.uxa-invalid {\n  border-color: var(--uxa-text-input__border-color--invalid);\n  background-color: var(--uxa-text-input__background-color--invalid);\n  box-shadow: none;\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-combobox-text-input.uxa-invalid:hover:not(:disabled),\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-combobox-text-input.uxa-invalid:hover:not(:disabled) {\n  border-color: var(--uxa-text-input__border-color--hover-invalid);\n  background-color: var(--uxa-text-input__background-color--hover-invalid);\n  box-shadow: var(--uxa-text-input__box-shadow--hover-invalid);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-disabled .uxa-combobox-text-input,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-disabled .uxa-combobox-text-input {\n  cursor: var(--uxa-text-input__cursor--disabled);\n  color: var(--uxa-text-input__color--disabled);\n  border-color: var(--uxa-text-input__border-color--disabled);\n  background-color: var(--uxa-text-input__background-color--disabled);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-disabled .uxa-combobox-text-input::-moz-placeholder, :not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-disabled .uxa-combobox-text-input::-moz-placeholder {\n  color: var(--uxa-text-input-placeholder__color--disabled);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-disabled .uxa-combobox-text-input::placeholder,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-disabled .uxa-combobox-text-input::placeholder {\n  color: var(--uxa-text-input-placeholder__color--disabled);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-combobox-trailing-addon,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-combobox-trailing-addon {\n  padding-inline: var(--uxa-select__padding-inline);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-small,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-small {\n  padding-inline: 0;\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox.uxa-small .uxa-combobox-trailing-addon,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox.uxa-small .uxa-combobox-trailing-addon {\n  padding-inline: var(--uxa-select__padding-inline--small);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-combobox .uxa-select-clear + .uxa-combobox-trailing-addon,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-combobox .uxa-select-clear + .uxa-combobox-trailing-addon {\n  padding-inline-start: 0;\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-clear {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: var(--uxa-select-clear-button__width);\n  height: var(--uxa-select-clear-button__height);\n  background-color: var(--uxa-select-clear-button__background-color, transparent);\n  border: var(--uxa-select-clear-button__border, none);\n  padding-inline: var(--uxa-select-clear-button__padding-inline);\n  padding-block: var(--uxa-select-clear-button__padding-block);\n  margin-inline-end: var(--uxa-select-clear-button__margin-inline-end);\n  outline: none;\n  cursor: pointer;\n  box-sizing: border-box;\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-clear:hover {\n  --uxa-select-clear-icon__background-color: var(\n    --uxa-select-clear-icon__background-color--hover\n  );\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-clear:active {\n  --uxa-select-clear-icon__background-color: var(\n    --uxa-select-clear-icon__background-color--active\n  );\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-clear.uxa-focused, :not(#\\9):not(#\\9):not(#\\9) .uxa-select-clear:focus-visible {\n  --uxa-select-clear-icon__background-color: var(\n    --uxa-select-clear-icon__background-color--focus\n  );\n  --uxa-select-clear-icon__box-shadow: var(--uxa-select-clear-icon__box-shadow--focus);\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-select-clear-icon {\n  display: inline-flex;\n  width: 100%;\n  height: 100%;\n  border-radius: var(--uxa-select-clear-icon__border-radius);\n  color: var(--uxa-select-clear-icon__color);\n  font-size: var(--uxa-select-clear-icon__font-size);\n  background-color: var(--uxa-select-clear-icon__background-color, transparent);\n  box-shadow: var(--uxa-select-clear-icon__box-shadow, none);\n}\n\n:not(#\\9):not(#\\9):not(#\\9) .uxa-leading-addon,\n:not(#\\9):not(#\\9):not(#\\9) .uxa-trailing-addon,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-leading-addon,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-trailing-addon {\n  display: flex;\n  align-items: center;\n  color: var(--uxa-input-group-addon-button__color, currentColor);\n  gap: var(--uxa-input-group-addon-button__gap);\n  --uxa-button__height: var(--uxa-input-group-addon-button__height);\n  --uxa-button__height--flat: var(--uxa-button__height);\n  --uxa-button__padding-inline: var(--uxa-input-group-addon-button__padding-inline);\n  --uxa-button__padding-block: var(--uxa-input-group-addon-button__padding-block);\n  --uxa-button__padding-inline--flat: var(--uxa-input-group-addon-button__padding-inline);\n  --uxa-button__padding-block--flat: var(--uxa-input-group-addon-button__padding-block);\n  --uxa-button__color--flat-secondary: var(--uxa-input-group-addon-button__color);\n  --uxa-button__border-color--flat-secondary: transparent;\n  --uxa-button__background-color--flat-secondary: transparent;\n  --uxa-button__border-color--flat-secondary-hover: transparent;\n  --uxa-button__border-color--flat-secondary-active: transparent;\n  --uxa-button__background-color--flat-secondary-active: var(\n    --uxa-input-group-addon-button__background-color--active\n  );\n  --uxa-icon-button__padding-inline: var(--uxa-button__padding-inline);\n  --uxa-icon-button__padding-block: var(--uxa-button__padding-block);\n  --uxa-icon-button-icon__size: 16px;\n}";
styleInject(css_248z$2);
function Combobox(_a) {
    var { placeholder, dropdownPlacement = "auto", defaultValue, value, onValueChange, onChange, children, isOpen, onOpenChange, isDisabled, onFilterChange, displayWith, id, className, maxHeight, style, controllerRef, clearable, trigger = "input", size, panelWidth, onScrolledToEnd } = _a, htmlProps = __rest(_a, ["placeholder", "dropdownPlacement", "defaultValue", "value", "onValueChange", "onChange", "children", "isOpen", "onOpenChange", "isDisabled", "onFilterChange", "displayWith", "id", "className", "maxHeight", "style", "controllerRef", "clearable", "trigger", "size", "panelWidth", "onScrolledToEnd"]);
    const { wrapperId, inputId } = useWrappedInputId(id, "uxa-combobox");
    ...
    const { triggerProps, inputProps, buttonProps, listboxProps, selectValue, open, isDropdownOpen, close, onSelect, isFocused, getValueAsString, activeDescendantRef, showClearButton, clear } = useSelect({
        id,
        value,
        onValueChange,
        onChange,
...
function Select(_a) {
    var { placeholder, dropdownPlacement = "auto", defaultValue, value, onValueChange, onChange, valueRender, children, isOpen, onOpenChange, isDisabled, id, className, style, ariaLabelledBy, maxHeight, displayWith, controllerRef, clearable, size, panelWidth, onScrolledToEnd } = _a, htmlProps = __rest(_a, ["placeholder", "dropdownPlacement", "defaultValue", "value", "onValueChange", "onChange", "valueRender", "children", "isOpen", "onOpenChange", "isDisabled", "id", "className", "style", "ariaLabelledBy", "maxHeight", "displayWith", "controllerRef", "clearable", "size", "panelWidth", "onScrolledToEnd"]);
    const { wrapperId, inputId } = useWrappedInputId(id, "uxa-select");
    const i18n = useSelectI18n();
    const isSSR = useIsSSR();
    const { triggerProps, inputProps, buttonProps, listboxProps, valueProps, selectValue, isDropdownOpen, close, onSelect, getValueAsString, activeDescendantRef, showClearButton, clear } = useSelect({
        id: wrapperId,
        ariaLabelledBy,
        value,
        onValueChange,
