...
function ToggleButton(_a) {
    var { value, isDisabled, ref } = _a, props = __rest(_a, ["value", "isDisabled", "ref"]);
    const { isChecked, select, isGroupDisabled } = useToggleButtonContext();
...
function ToggleButtonGroup(_a) {
    var { primary, secondary, isDisabled, selectionMode = "single", onValueChange, children, value } = _a, props = __rest(_a, ["primary", "secondary", "isDisabled", "selectionMode", "onValueChange", "children", "value"]);
