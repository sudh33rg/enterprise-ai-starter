...
function useHiddenInputHtmlProps(props) {
    const { accept, alt, autoComplete, autoFocus, capture, checked, disabled, enterKeyHint, form, formAction, formEncType, formMethod, formNoValidate, formTarget, height, list, max, maxLength, min, minLength, multiple, name, pattern, placeholder, readOnly, required, size, src, step, type, value, width, onChange } = props, wrapperHtmlProps = __rest(props, ["accept", "alt", "autoComplete", "autoFocus", "capture", "checked", "disabled", "enterKeyHint", "form", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "height", "list", "max", "maxLength", "min", "minLength", "multiple", "name", "pattern", "placeholder", "readOnly", "required", "size", "src", "step", "type", "value", "width", "onChange"]);
    return {
        inputHtmlProps: {
            accept,
            alt,
