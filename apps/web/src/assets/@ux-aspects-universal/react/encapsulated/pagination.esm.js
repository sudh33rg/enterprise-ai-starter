 ...
 * once.
 */
const Pagination = ({ page = 1, pageCount = 1, limit = 5, flat = false, onPageChange }) => {
    var _a;
...
function PaginationLink(_a) {
    var { isDisabled, children } = _a, props = __rest(_a, ["isDisabled", "children"]);
...
const PaginationBar = forwardRef(({ alignment = "center", dropdown, itemCount, children }, ref) => {
    return React.createElement(FocusKeyManager, {
        orientation: "horizontal"
    }, React.createElement("div", {
        ref: ref,
