...
function useNotificationLauncher() {
    ...
    const openToast = useCallback((component, _a = {}) => {
        var { alignment = "start", placement = "bottom", role = "alert", width = "var(--uxa-notification-toast__width)" } = _a, config = __rest(_a, ["alignment", "placement", "role", "width"]);
...
function useNotification() {
    const { open, openToast, dismissAll } = useNotificationContext();
    return {
        open,
        openToast,
        dismissAll
