const opentext = {
    ...
    colorStatusSuccess: props => {
        return `${resolveValue(props, props.theme.colorEmerald)}`;
    },
    colorStatusSuccessRgb: props => {
        return `${resolveValue(props, props.theme.colorEmeraldRgb)}`;
    },
    colorStatusSuccessContrast: props => {
        return `${resolveValue(props, props.theme.colorEmeraldContrast)}`;
    },
    colorStatusSuccessContrastRgb: props => {
        return `${resolveValue(props, props.theme.colorEmeraldContrastRgb)}`;
    },
    colorStatusWarning: "#df6800",
    colorStatusWarningRgb: "223, 104, 0",
    colorStatusWarningContrast: "#000",
    colorStatusWarningContrastRgb: "0, 0, 0",
    colorStatusError: props => {
        return `${resolveValue(props, props.theme.colorFirebrick)}`;
    },
    colorStatusErrorRgb: props => {
        return `${resolveValue(props, props.theme.colorFirebrickRgb)}`;
    },
    colorStatusErrorContrast: props => {
        return `${resolveValue(props, props.theme.colorFirebrickContrast)}`;
    },
    colorStatusErrorContrastRgb: props => {
        return `${resolveValue(props, props.theme.colorFirebrickContrastRgb)}`;
    },
    colorStatusInfo: props => {
        return `${resolveValue(props, props.theme.colorPrimaryActive)}`;
    },
    colorStatusInfoRgb: props => {
        return `${resolveValue(props, props.theme.colorPrimaryActiveRgb)}`;
    },
    colorStatusInfoContrast: props => {
        return `${resolveValue(props, props.theme.colorPrimaryActiveContrast)}`;
    },
    colorStatusInfoContrastRgb: props => {
        return `${resolveValue(props, props.theme.colorPrimaryActiveContrastRgb)}`;
    },
    ...
    colorPrimary: props => {
        return `${resolveValue(props, props.theme.colorIndigo)}`;
    },
    colorPrimaryRgb: props => {
        return `${resolveValue(props, props.theme.colorIndigoRgb)}`;
    },
    colorPrimaryContrast: props => {
        return `${resolveValue(props, props.theme.colorIndigoContrast)}`;
    },
    colorPrimaryContrastRgb: props => {
        return `${resolveValue(props, props.theme.colorIndigoContrastRgb)}`;
    },
    colorPrimaryHover: "#171f4c",
    colorPrimaryHoverRgb: "23, 31, 76",
    colorPrimaryHoverContrast: "#fff",
    colorPrimaryHoverContrastRgb: "255, 255, 255",
    colorPrimaryActive: "#2e3d98",
    colorPrimaryActiveRgb: "46, 61, 152",
    ...
    colorSecondaryFocusRgb: props => {
        return `${resolveValue(props, props.theme.colorPrimaryFocusRgb)}`;
    },
    colorSecondaryFocusContrast: props => {
        return `${resolveValue(props, props.theme.colorPrimaryFocusContrast)}`;
    },
    colorSecondaryFocusContrastRgb: props => {
        return `${resolveValue(props, props.theme.colorPrimaryFocusContrastRgb)}`;
    },
    ...
    colorMagenta: "#a0006b",
    colorMagentaRgb: "160, 0, 107",
    colorMagentaContrast: "#fff",
    colorMagentaContrastRgb: "255, 255, 255",
    colorFuchsia: "#c6179d",
    ...
    colorIndigo: "#232e72",
    colorIndigoRgb: "35, 46, 114",
    colorIndigoContrast: "#fff",
    colorIndigoContrastRgb: "255, 255, 255",
    ...
    colorLightBlue: "#09bcef",
    colorLightBlueRgb: "9, 188, 239",
    ...
    typographyFontFamily: "\"OpenText Sans\", Helvetica, Arial, sans-serif",
    ...
    typographyColorBody: "#333333",
    typographyColorBodyRgb: "51, 51, 51",
    typographyColorBodyContrast: "#fff",
    typographyColorBodyContrastRgb: "255, 255, 255",
    ...
    typographyHeading1FontSize: "2rem",
    typographyHeading1FontWeight: props => {
        return `${resolveValue(props, props.theme.typographyFontWeightLight)}`;
    },
    typographyHeading1Color: props => {
        return `${resolveValue(props, props.theme.typographyColorBody)}`;
    },
    typographyHeading1TextTransform: "none",
    typographyHeading1LineHeight: "2.5rem",
    typographyHeading2FontSize: "1.625rem",
    ...
    typographyHeading2LineHeight: "1.375rem",
    ...
    typographyHeading3LineHeight: "2rem",
    ...
    typographyHeading4LineHeight: "1.75rem",
    ...
    typographyHeading5LineHeight: "1.5rem",
    ...
    typographyBodyLineHeight: "1.375rem",
    ...
    focusIndicatorBoxShadow: props => {
        return `inset 0px 0px 0px 1px ${resolveValue(props, props.theme.colorSecondaryFocus)},
    inset 0px 0px 0px 2px ${resolveValue(props, props.theme.elevationBackgroundColor)}`;
    },
    ...
    overlayZIndex: "1000",
    elevationBackgroundColorBase: "#f6f6f6",
    ...
    elevationBoxShadowColor1: "rgba(0, 0, 0, 0.7)",
    elevationBoxShadow1: props => {
        return `0 0 3px ${resolveValue(props, props.theme.elevationBoxShadowColor1)}`;
    },
    elevationBorderColor1: "transparent",
    elevationBackgroundColor2: props => {
        return `${resolveValue(props, props.theme.colorWhite)}`;
    },
    elevationBoxShadowColor2: "rgba(0, 0, 0, 0.7)",
    elevationBoxShadow2: props => {
        return `0 0 3px ${resolveValue(props, props.theme.elevationBoxShadowColor2)}`;
    },
    ...
    elevationBoxShadowColor3: "rgba(0, 0, 0, 0.7)",
    elevationBoxShadow3: props => {
        return `0 0 3px ${resolveValue(props, props.theme.elevationBoxShadowColor3)}`;
    },
    ...
    elevationBoxShadowColor4: "rgba(0, 0, 0, 0.7)",
    elevationBoxShadow4: props => {
        return `0 0 3px ${resolveValue(props, props.theme.elevationBoxShadowColor4)}`;
    },
    ...
    alertFontSize: props => {
        return `${resolveValue(props, props.theme.typographyFontSizeXlarge)}`;
    },
    alertFontWeight: props => {
        return `${resolveValue(props, props.theme.typographyFontWeightRegular)}`;
    },
    alertMinHeight: "3rem",
    alertLineHeight: "1.5rem",
    alertHeight: "auto",
    alertBorderWidth: props => {
        return `${resolveValue(props, props.theme.alertBorderWidthTop)} ${resolveValue(props, props.theme.alertBorderWidthRight)}
    ${resolveValue(props, props.theme.alertBorderWidthBottom)} ${resolveValue(props, props.theme.alertBorderWidthLeft)}`;
    },
    alertBorderStyle: "solid",
    alertBorderColor: props => {
        return `${resolveValue(props, props.theme.colorStatusInfo)}`;
    },
    alertPaddingInline: "16px 16px",
    alertPaddingBlock: "12px 12px",
    alertBackgroundColorInfo: "rgba(46, 61, 152, 0.05)",
    alertColorInfo: props => {
        return `${resolveValue(props, props.theme.typographyColorBody)}`;
    },
    alertBackgroundColorError: "rgba(223, 51, 36, 0.05)",
    alertColorError: props => {
        return `${resolveValue(props, props.theme.typographyColorBody)}`;
    },
    alertBackgroundColorSuccess: "rgba(6, 125, 20, 0.05)",
    alertColorSuccess: props => {
        return `${resolveValue(props, props.theme.typographyColorBody)}`;
    },
    alertBackgroundColorWarning: "rgba(223, 104, 0, 0.05)",
    ...
    breadcrumbSeparatorBackgroundImage: "url(\"data:image/svg+xml;base64,\")",
    ...
    breadcrumbSeparatorBackgroundImageMasthead: "url(\"data:image/svg+xml;base64,\")",
    ...
    buttonBackgroundColorPrimaryDisabled: "#999999",
    buttonBorderColorPrimaryDisabled: props => {
        return `${resolveValue(props, props.theme.buttonBorderColorPrimary)}`;
    },
    buttonColorSecondary: props => {
        return `${resolveValue(props, props.theme.colorSecondary)}`;
    },
    ...
    buttonBorderWidthSecondary: "1px",
    buttonBorderStyleSecondary: "solid",
    buttonBoxShadowSecondaryHover: props => {
        return `inset 0 0 0 1px ${resolveValue(props, props.theme.colorSecondaryHover)}`;
    },
    ...
    buttonBackgroundColorSecondaryHover: props => {
        return `${resolveValue(props, props.theme.buttonBackgroundColorSecondary)}`;
    },
    buttonBoxShadowSecondaryActive: props => {
        return `inset 0 0 0 1px ${resolveValue(props, props.theme.colorSecondaryActive)}`;
    },
    ...
    buttonBoxShadowSecondaryFocused: props => {
        return `${resolveValue(props, props.theme.colorWhite)} 0px 0px 0px 2px inset,
    ${resolveValue(props, props.theme.colorSecondaryFocus)} 0px 0px 0px 3px inset`;
    },
    ...
    buttonPaddingInlineFlat: "0.5rem",
    buttonPaddingBlockFlat: "0rem",
    ...
    buttonBorderWidthFlatPrimary: "0",
    ...
    buttonColorFlatPrimaryHover: props => {
        return `${resolveValue(props, props.theme.buttonColorSecondaryHover)}`;
    },
    ...
    buttonColorFlatPrimaryActive: props => {
        return `${resolveValue(props, props.theme.buttonColorSecondaryActive)}`;
    },
    ...
    buttonBackgroundColorFlatPrimaryDisabled: props => {
        return `${resolveValue(props, props.theme.buttonBackgroundColorFlat)}`;
    },
    ...
    buttonBackgroundColorFlatSecondary: props => {
        return `${resolveValue(props, props.theme.buttonBackgroundColorFlatPrimary)}`;
    },
    buttonBorderColorFlatSecondary: props => {
        return `${resolveValue(props, props.theme.buttonBorderColorFlatPrimary)}`;
    },
    buttonBorderWidthFlatSecondary: props => {
        return `${resolveValue(props, props.theme.buttonBorderWidthFlatPrimary)}`;
    },
    buttonBorderStyleFlatSecondary: "solid",
    buttonFontWeightFlatSecondary: props => {
        return `${resolveValue(props, props.theme.buttonFontWeightFlat)}`;
    },
    buttonBoxShadowFlatSecondaryHover: "none",
    buttonBorderColorFlatSecondaryHover: props => {
        return `${resolveValue(props, props.theme.buttonBorderColorFlatPrimaryHover)}`;
    },
    buttonColorFlatSecondaryHover: props => {
        return `${resolveValue(props, props.theme.buttonColorFlatPrimaryHover)}`;
    },
    ...
    buttonBorderColorFlatSecondaryActive: props => {
        return `${resolveValue(props, props.theme.buttonBorderColorFlatPrimaryActive)}`;
    },
    buttonColorFlatSecondaryActive: props => {
        return `${resolveValue(props, props.theme.buttonColorFlatPrimaryActive)}`;
    },
    buttonBackgroundColorFlatSecondaryActive: props => {
        return `${resolveValue(props, props.theme.buttonBackgroundColorFlatPrimaryActive)}`;
    },
    buttonColorFlatSecondaryDisabled: props => {
        return `${resolveValue(props, props.theme.typographyColorDisabled)}`;
    },
    buttonBackgroundColorFlatSecondaryDisabled: props => {
        return `${resolveValue(props, props.theme.buttonBackgroundColorFlatPrimaryDisabled)}`;
    },
    ...
    buttonBorderColorFlatSecondaryFocused: props => {
        return `${resolveValue(props, props.theme.buttonBorderColorFlatPrimaryFocused)}`;
    },
    buttonColorFlatSecondaryFocused: props => {
        return `${resolveValue(props, props.theme.buttonColorFlatPrimaryFocused)}`;
    },
    buttonBackgroundColorFlatSecondaryFocused: props => {
        return `${resolveValue(props, props.theme.buttonBackgroundColorFlatPrimaryFocused)}`;
    },
    ...
    buttonBorderWidthFlatNegative: "0",
    ...
    buttonColumnGapSmall: "4px",
    buttonHeightSmall: "1.5rem",
    buttonMinWidthSmall: "70px",
    buttonBorderRadiusSmall: "0.75rem",
    buttonPaddingInlineSmall: "1rem",
    ...
    buttonColumnGapLarge: "8px",
    buttonHeightLarge: "3rem",
    buttonMinWidthLarge: "90px",
    buttonBorderRadiusLarge: "1.75rem",
    ...
    chipBackgroundColorSelected: props => {
        return `rgba(${resolveValue(props, props.theme.colorPrimaryRgb)}, 0.15)`;
    },
    ...
    chipBackgroundColorSelectedHover: props => {
        return `rgba(${resolveValue(props, props.theme.colorPrimaryRgb)}, 0.25)`;
    },
    ...
    datePickerPaddingInline: "1rem",
    datePickerPaddingBlock: "1rem",
    ...
    datePickerHeaderMarginBlockEnd: "0",
    ...
    datePickerCalendarHeaderFontSize: props => {
        return `${resolveValue(props, props.theme.typographyFontSizeSmall)}`;
    },
    ...
    datePickerGridCellWidth: "40px",
    datePickerGridCellMinWidth: "0",
    datePickerGridCellHeight: "40px",
    datePickerGridCellFontSize: props => {
        return `${resolveValue(props, props.theme.typographyFontSizeSmall)}`;
    },
    datePickerGridCellBackgroundColor: "transparent",
    ...
    datePickerGridCellBackgroundColorSelectionBetween: props => {
        return `${resolveValue(props, props.theme.colorNavy)}`;
    },
    ...
    datePickerGridCellBoxShadowDisabledSelectionStart: "none",
    datePickerGridCellBoxShadowDisabledSelectionEnd: "none",
    ...
    dateRangePickerSummaryBorderBottom: "1px solid rgba(0, 0, 0, 0.2)",
    ...
    formGap: "24px",
    formFieldLabelMarginBlockEnd: "0",
    ...
    iconButtonMinWidth: "0",
    iconButtonBorderRadiusCircular: "16px",
    ...
    iconButtonWidthSmall: props => {
        return `${resolveValue(props, props.theme.iconButtonWidth)}`;
    },
    iconButtonHeightSmall: props => {
        return `${resolveValue(props, props.theme.buttonHeightSmall)}`;
    },
    iconButtonPaddingInlineSmall: "8px",
    iconButtonPaddingBlockSmall: "8px",
    iconButtonIconSizeSmall: props => {
        return `${resolveValue(props, props.theme.iconButtonIconSize)}`;
    },
    iconButtonWidthLarge: props => {
        return `${resolveValue(props, props.theme.iconButtonWidth)}`;
    },
    iconButtonHeightLarge: props => {
        return `${resolveValue(props, props.theme.buttonHeightLarge)}`;
    },
    iconButtonPaddingInlineLarge: "8px",
    iconButtonPaddingBlockLarge: "8px",
    iconButtonIconSizeLarge: "1.5rem",
    iconButtonWidthExtraLarge: props => {
        return `${resolveValue(props, props.theme.iconButtonWidth)}`;
    },
    iconButtonHeightExtraLarge: "3rem",
    iconButtonPaddingInlineExtraLarge: "8px",
    iconButtonPaddingBlockExtraLarge: "8px",
    ...
    inlineNotificationBorderColorInfo: "rgba(0, 100, 202, 0.2)",
    ...
    inlineNotificationBorderColorWarning: "rgba(255, 192, 2, 0.2)",
    ...
    inlineNotificationBorderColorError: "rgba(229, 0, 76, 0.15)",
    ...
    inlineNotificationBorderColorSuccess: "rgba(26, 172, 96, 0.2)",
    ...
    inputGroupPaddingInlineStart: props => {
    ...
    inputGroupBorderColorDisabled: "transparent",
    inputGroupColorDisabled: props => {
        return `${resolveValue(props, props.theme.textInputColor)}`;
    },
    inputGroupBackgroundColorDisabled: "#f9f9f9",
    ...
    inputGroupBoxShadowFocused: props => {
        return `${resolveValue(props, props.theme.colorPrimaryActive)} 0 1px 0 0`;
    },
    ...
    searchGroupBackgroundColor: props => {
        return `${resolveValue(props, props.theme.inputGroupBackgroundColor)}`;
    },
    searchGroupBorderColor: props => {
        return `${resolveValue(props, props.theme.inputGroupBorderColor)}`;
    },
    ...
    loginPanelBorder: props => {
        return `1px solid ${resolveValue(props, props.theme.elevationBorderColor3)}`;
    },
    ...
    loginPanelGridTemplateAreas: "\"icon language\" \"title title\" \"form form\" \"brand links\"",
    ...
    loginTitleSecondaryColor: props => {
        return `rgba(${resolveValue(props, props.theme.colorBlackRgb)}, 0.65)`;
    },
    ...
    61deg,
    ${resolveValue(props, props.theme.colorNavy2)} 0%,
    #122c69 59%,
    #078db3 100%
  )`;
    },
    mastheadHeightPrimary: "64px",
    mastheadGapPrimary: "24px",
    mastheadBorderBottomWidthSecondary: props => {
        return `${resolveValue(props, props.theme.tabListBorderBottomWidth)}`;
    },
    mastheadGridTemplateColumnsPrimary: "auto 1fr auto",
    mastheadGridTemplateAreasPrimary: "\"icon main actions\"",
    ...
    mastheadBorderBottomColorSecondary: props => {
        return `${resolveValue(props, props.theme.tabListBorderColor)}`;
    },
    mastheadSeparatorWidth: "1px",
    mastheadSeparatorHeight: "24px",
    mastheadSeparatorMarginInline: props => {
    ...
    mastheadTitleFontSize: "21px",
    mastheadTitleMarginInline: "0",
    mastheadTitleMarginBlock: "0",
    mastheadTitleLineHeight: "normal",
    ...
    mastheadTabIndicatorWidthSelected: "100%",
    ...
    mastheadActionBackgroundColorHover: "transparent",
    mastheadActionBackgroundColorActive: "transparent",
    mastheadActionBackgroundColorFocus: "transparent",
    mastheadAvatarMarginInlineStart: "2px",
    mastheadMainContentMarginInlineStart: "0",
    mastheadMyAviatorMarginInlineStart: "10px",
    menuMinWidth: "initial",
    menuFilter: props => {
        return `drop-shadow(0 0 3px ${resolveValue(props, props.theme.elevationBoxShadowColor4)})`;
    },
    menuBorderRadius: "0",
    menuBoxShadow: "none",
    menuBorderWidth: "1px",
    ...
    menuItemBackgroundColorHover: "#b2bec5",
    ...
    menuItemBoxShadowFocus: props => {
        return `${resolveValue(props, props.theme.focusIndicatorBoxShadowSecondary)}`;
    },
    menuItemColorDisabled: props => {
        return `${resolveValue(props, props.theme.typographyColorDisabled)}`;
    },
    menuItemCursorDisabled: "default",
    menuItemBackgroundColorSelected: "#cbd3d9",
    ...
    navigationItemBoxShadowActive: props => {
        return `inset 3px 0 0 ${resolveValue(props, props.theme.colorPrimary)}`;
    },
    ...
    paginationDividerBackgroundColor: "rgba(0, 0, 0, 0.1)",
    ...
    popoverFilter: "drop-shadow(0px 0px 4px rgba(0, 0, 0, 0.25))",
    popoverBoxShadow: "none",
    popoverBorderWidth: "1px",
    popoverBorderStyle: "solid",
    popoverBorderColor: props => {
        return `${resolveValue(props, props.theme.popoverBorderColorLight)}`;
    },
    popoverBackgroundColor: props => {
        return `${resolveValue(props, props.theme.popoverBackgroundColorLight)}`;
    },
    popoverColor: props => {
        return `${resolveValue(props, props.theme.popoverColorLight)}`;
    },
    ...
    popoverBackgroundColorLight: "#f5f5f5",
    ...
    radioButtonLabelLineHeight: "1.125rem",
    radioButtonLabelFontWeight: "400",
    radioButtonLabelFontWeightChecked: "400",
    radioButtonLabelColorDisabled: "#666666",
    ...
    selectOptionPanelBorderRadius: props => {
        return `${resolveValue(props, props.theme.menuBorderRadius)}`;
    },
    ...
    splitButtonPaddingInline: "24px 12px",
    splitButtonPaddingBlock: "0",
    splitIconButtonPaddingInline: "8px 12px",
    splitIconButtonPaddingBlock: "0",
    splitIconButtonWidth: "initial",
    ...
    splitButtonPaddingInlineSmall: "8px 5px",
    splitButtonPaddingBlockSmall: "0",
    splitIconButtonWidthSmall: "initial",
    ...
    splitButtonDividerBackgroundSecondary: "rgba(50, 52, 53, 0.5)",
    ...
    splitButtonDividerBackgroundSecondaryFlat: "rgba(0, 0, 0, 0.5)",
    splitButtonDividerBackgroundDisabled: "rgba(0, 0, 0, 0.2)",
    ...
    tableHeaderCellBorderColor: "#8f8f8f",
    ...
    tableHeaderCellBackgroundColor: "#f9f9f9",
    ...
    tableRowOutlineFocused: props => {
        return `1px solid ${resolveValue(props, props.theme.focusOutlineColor)}`;
    },
    tableRowOutlineOffsetFocused: "-1px",
    tableRowHeightSmall: "36px",
    tableRowHeightLarge: "64px",
    tableRowHeightExtralarge: "64px",
    tableCellBoxSizing: "content-box",
    tableCellBorderColor: "#e6e6e6",
    ...
    tableCellBackgroundColorHover: "#b2bec5",
    tableCellBackgroundColorSelected: "#cbd3d9",
    ...
    tabListBorderColor: "#cccccc",
    tabListBorderBottomWidthVertical: "0",
    tabListBorderInlineEndWidthVertical: "1px",
    tabListHeightSmall: props => {
        return `${resolveValue(props, props.theme.tabListHeightMedium)}`;
    },
    tabListHeightMedium: "3rem",
    tabBackgroundColor: "transparent",
    tabMarginInline: "16px",
    tabBorder: "none",
    tabPaddingInline: "0",
    tabPaddingBlock: "0",
    tabFontWeight: props => {
    ...
    tabIndicatorBackgroundColorHover: props => {
        return `${resolveValue(props, props.theme.colorLightBlue)}`;
    },
    ...
    textInputBackgroundColor: "#efefef",
    textInputBorderWidth: props => {
        return `${resolveValue(props, props.theme.textInputBorderWidthTop)}
    ${resolveValue(props, props.theme.textInputBorderWidthRight)} ${resolveValue(props, props.theme.textInputBorderWidthBottom)}
    ${resolveValue(props, props.theme.textInputBorderWidthLeft)}`;
    },
    textInputBorderStyle: "solid",
    textInputBorderColor: "#666666",
    ...
    textInputBorderRadius: "3px 3px 0 0",
    textInputWidth: "100%",
    ...
    textInputBorderColorDisabled: "transparent",
    textInputCursorDisabled: "default",
    textInputColorDisabled: props => {
        return `${resolveValue(props, props.theme.textInputColor)}`;
    },
    textInputBackgroundColorDisabled: "#f9f9f9",
    ...
    textareaPaddingBlockStart: "4px",
    textareaPaddingBlockEnd: props => {
        return `${resolveValue(props, props.theme.textareaPaddingBlockStart)}`;
    },
    textareaColor: props => {
        return `${resolveValue(props, props.theme.typographyColorHighEmphasis)}`;
    },
    ...
    textareaBorderWidth: props => {
        return `${resolveValue(props, props.theme.textInputBorderWidth)}`;
    },
    textareaBorderStyle: props => {
        return `${resolveValue(props, props.theme.textInputBorderStyle)}`;
    },
    ...
    textareaPlaceholderColorDisabled: props => {
        return `${resolveValue(props, props.theme.textareaPlaceholderColor)}`;
    },
    ...
    toggleButtonGroupBorderRadius: "3px",
    ...
    toggleButtonBorderRadius: "3px",
    toggleButtonBorderRadiusFocused: props => {
        return `${resolveValue(props, props.theme.toggleButtonBorderRadius)}`;
    },
    ...
    toggleSwitchTrackBackgroundColorDisabled: "#999999",
    ...
    toggleSwitchThumbInsetInlineEnd: "26px",
    ...
    toggleSwitchThumbBorderColor: "transparent",
    toggleSwitchThumbTransition: "all 0.16s ease",
    toggleSwitchThumbInsetInlineStartChecked: "26px",
    toggleSwitchThumbInsetInlineEndChecked: "4px",
    toggleSwitchThumbBackgroundColorChecked: props => {
        return `${resolveValue(props, props.theme.colorWhite)}`;
    },
    toggleSwitchThumbBorderColorChecked: props => {
        return `${resolveValue(props, props.theme.toggleSwitchThumbBorderColor)}`;
    },
    toggleSwitchThumbInsetInlineEndHover: props => {
        return `${resolveValue(props, props.theme.toggleSwitchThumbInsetInlineEnd)}`;
    },
    ...
    toggleSwitchThumbBackgroundColorDisabled: "#cccccc",
    ...
    toggleSwitchThumbBackgroundColorDisabledChecked: props => {
        return `${resolveValue(props, props.theme.toggleSwitchThumbBackgroundColorDisabled)}`;
    },
    toggleSwitchThumbBoxShadowDisabledChecked: "none",
    toggleSwitchThumbBoxShadowFocused: "none",
    ...
    toolbarHeight: "40px",
    toolbarPaddingInline: "24px",
    toolbarPaddingBlock: "0",
    toolbarBackgroundColor: "#eef2f4",
    ...
    treeNodeBackgroundColorActiveHover: props => {
        return `rgba(${resolveValue(props, props.theme.colorPrimaryRgb)}, 0.3)`;
    },
    ...
    colorNavy: "#111b58",
    colorNavyRgb: "17, 27, 88",
    colorNavyContrast: "#fff",
    colorNavyContrastRgb: "255, 255, 255",
    colorTeal: "#00b8ba",
    colorTealRgb: "0, 184, 186",
    colorTealContrast: "#000",
    colorTealContrastRgb: "0, 0, 0",
    colorSteel: "#7e929f",
    colorSteelRgb: "126, 146, 159",
    colorSteelContrast: "#000",
    colorSteelContrastRgb: "0, 0, 0",
    colorMadderRed2: "#5d0026",
    colorMadderRed2Rgb: "93, 0, 38",
    colorMadderRed2Contrast: "#fff",
    colorMadderRed2ContrastRgb: "255, 255, 255",
    colorLightBlue2: "#055e78",
    colorLightBlue2Rgb: "5, 94, 120",
    colorLightBlue2Contrast: "#000",
    colorLightBlue2ContrastRgb: "0, 0, 0",
    colorBurnt: "#f05822",
    colorBurntRgb: "240, 88, 34",
    colorBurntContrast: "#000",
    colorBurntContrastRgb: "0, 0, 0",
    colorNavy2: "#090e2c",
    colorNavy2Rgb: "9, 14, 44",
    colorNavy2Contrast: "#fff",
    colorNavy2ContrastRgb: "255, 255, 255",
    colorFirebrick: "#df3324",
    colorFirebrickRgb: "223, 51, 36",
    colorFirebrickContrast: "#000",
    colorFirebrickContrastRgb: "0, 0, 0",
    colorPine: "#006353",
    colorPineRgb: "0, 99, 83",
    colorPineContrast: "#000",
    colorPineContrastRgb: "0, 0, 0",
    colorGreen: "#8cc53e",
    colorGreenRgb: "140, 197, 62",
    colorGreenContrast: "#000",
    colorGreenContrastRgb: "0, 0, 0",
    colorCerulean2: "#003b4d",
    colorCerulean2Rgb: "0, 59, 77",
    colorCerulean2Contrast: "#fff",
    colorCerulean2ContrastRgb: "255, 255, 255",
    colorLake: "#0084ce",
    colorLakeRgb: "0, 132, 206",
    colorLakeContrast: "#000",
    colorLakeContrastRgb: "0, 0, 0",
    colorDiscovery2: "#775909",
    colorDiscovery2Rgb: "119, 89, 9",
    colorDiscovery2Contrast: "#000",
    colorDiscovery2ContrastRgb: "0, 0, 0",
    colorLake2: "#004267",
    colorLake2Rgb: "0, 66, 103",
    colorLake2Contrast: "#fff",
    colorLake2ContrastRgb: "255, 255, 255",
    colorFirebrick1: "#a7261b",
    colorFirebrick1Rgb: "167, 38, 27",
    colorFirebrick1Contrast: "#000",
    colorFirebrick1ContrastRgb: "0, 0, 0",
    colorRaspberry: "#e00051",
    colorRaspberryRgb: "224, 0, 81",
    colorRaspberryContrast: "#fff",
    colorRaspberryContrastRgb: "255, 255, 255",
    focusIndicatorBoxShadowSecondary: props => {
        return `inset 0px 0px 0px 2px
      ${resolveValue(props, props.theme.elevationBackgroundColor)},
    inset 0px 0px 0px 3px ${resolveValue(props, props.theme.colorPrimaryActive)}`;
    },
    alertBorderWidthTop: "0",
    alertBorderWidthRight: "0",
    alertBorderWidthBottom: "1px",
    alertBorderWidthLeft: "0",
    alertBorderColorInfo: props => {
        return `${resolveValue(props, props.theme.colorStatusInfo)}`;
    },
    alertBorderColorError: props => {
        return `${resolveValue(props, props.theme.colorStatusError)}`;
    },
    alertBorderColorSuccess: props => {
        return `${resolveValue(props, props.theme.colorStatusSuccess)}`;
    },
    alertBorderColorWarning: props => {
        return `${resolveValue(props, props.theme.colorStatusWarning)}`;
    },
    datePickerTitleFontSize: props => {
        return `${resolveValue(props, props.theme.typographyFontSize)}`;
    },
    datePickerTitleFontWeight: props => {
        return `${resolveValue(props, props.theme.datePickerHeaderFontWeight)}`;
    },
    datePickerGridCellBorderStartStartRadius: "50%",
    datePickerGridCellBorderStartEndRadius: "50%",
    datePickerGridCellBorderEndStartRadius: "50%",
    datePickerGridCellBorderEndEndRadius: "50%",
    datePickerGridCellBorderStartStartRadiusSelectionStart: "50%",
    datePickerGridCellBorderStartEndRadiusSelectionStart: "0",
    datePickerGridCellBorderEndStartRadiusSelectionStart: "50%",
    datePickerGridCellBorderEndEndRadiusSelectionStart: "0",
    datePickerGridCellBorderStartStartRadiusSelectionEnd: "0",
    datePickerGridCellBorderStartEndRadiusSelectionEnd: "50%",
    datePickerGridCellBorderEndStartRadiusSelectionEnd: "0",
    datePickerGridCellBorderEndEndRadiusSelectionEnd: "50%",
    datePickerGridCellBorderStartStartRadiusSelectionBetween: "0",
    datePickerGridCellBorderStartEndRadiusSelectionBetween: "0",
    datePickerGridCellBorderEndStartRadiusSelectionBetween: "0",
    datePickerGridCellBorderEndEndRadiusSelectionBetween: "0",
    formFieldFeedbackColor: props => {
        return `${resolveValue(props, props.theme.colorStatusError)}`;
    },
    inputGroupBackgroundColor: "#efefef",
    loginFormActionGroupBackgroundColor: "#efefef",
    selectPaddingBlock: "0 0",
    selectArrowSize: "16px",
    textInputBorderWidthTop: "0",
    textInputBorderWidthRight: "0",
    textInputBorderWidthBottom: "1px",
    textInputBorderWidthLeft: "0"
};
