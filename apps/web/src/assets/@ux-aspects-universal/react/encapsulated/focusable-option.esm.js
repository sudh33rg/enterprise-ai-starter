...
var css_248z$6 = ":not(#\\9):not(#\\9):not(#\\9) .uxa-form-action-group,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-form-action-group {\n  display: grid;\n  grid-auto-flow: column;\n  justify-content: var(--uxa-form-action-group__justify-content, flex-end);\n  gap: var(--uxa-form-action-group__gap);\n  grid-column: var(--uxa-form-action-group__grid-column, auto);\n  margin-block-start: var(--uxa-form-action-group__margin-block-start);\n}";
styleInject(css_248z$6);
var css_248z$5 = ":not(#\\9):not(#\\9):not(#\\9) .uxa-form-field,\n:not(#\\9):not(#\\9):not(#\\9) :host.uxa-form-field {\n  display: var(--uxa-form-field__display, block);\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-form-field:has(uxa-inline-edit.uxa-small):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) .uxa-form-field:has(.uxa-inline-edit.uxa-small):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-form-field:has(uxa-inline-edit.uxa-small):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-form-field:has(.uxa-inline-edit.uxa-small):has(.uxa-inline-edit-control) {\n  --uxa-form-field-feedback__margin-block-end: var(\n    --uxa-form-field-feedback__margin-block-end--small\n  );\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-form-field:has(uxa-inline-edit.uxa-medium):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) .uxa-form-field:has(.uxa-inline-edit.uxa-medium):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-form-field:has(uxa-inline-edit.uxa-medium):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-form-field:has(.uxa-inline-edit.uxa-medium):has(.uxa-inline-edit-control) {\n  --uxa-form-field-feedback__margin-block-end: var(\n    --uxa-form-field-feedback__margin-block-end--medium\n  );\n}\n:not(#\\9):not(#\\9):not(#\\9) .uxa-form-field:has(uxa-inline-edit.uxa-large):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) .uxa-form-field:has(.uxa-inline-edit.uxa-large):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-form-field:has(uxa-inline-edit.uxa-large):has(.uxa-inline-edit-control), :not(#\\9):not(#\\9):not(#\\9) :host.uxa-form-field:has(.uxa-inline-edit.uxa-large):has(.uxa-inline-edit-control) {\n  --uxa-form-field-feedback__margin-block-end: var(\n    --uxa-form-field-feedback__margin-block-end--large\n  );\n}";
styleInject(css_248z$5);
const FormField = _a => {
    var { isValid = true, children } = _a, props = __rest(_a, ["isValid", "children"]);
...
const FormFieldLabel = forwardRef((_a, ref) => {
    var { isRequired, children } = _a, props = __rest(_a, ["isRequired", "children"]);
...
function useFocusableControl({ onFocus } = {}) {
    const { setOnFocus } = useFocusableControlContext();
