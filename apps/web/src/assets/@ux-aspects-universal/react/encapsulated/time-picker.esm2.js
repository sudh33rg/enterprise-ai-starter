...
function useTimePicker({ value, hourMode = 12, offsets, isDisabled, id, onValueChange }) {
    const dateTimeAdapter = useDateTimeAdapter();
    const { hourPickerAriaLabel, minutePickerAriaLabel, secondPickerAriaLabel, offsetPickerAriaLabel } = useTimePickerI18n();
...
function useOffsetPicker({ id, ariaLabel, value, timeOffsets: providedOffsets = [], isDisabled, onValueChange }) {
    const dateTimeAdapter = useDateTimeAdapter();
...
const TimeValuePicker = ({ id, ariaLabel, className, value, isDisabled, formatValue, onValueChange, onIncrement, onDecrement }) => {
...
function TimePicker(_a) {
    var { value, isDisabled, hourMode = 12, id: initialId, offsets = [], showOffset, showSeconds, onValueChange } = _a, props = __rest(_a, ["value", "isDisabled", "hourMode", "id", "offsets", "showOffset", "showSeconds", "onValueChange"]);
    const { hourPickerProps, minutePickerProps, secondPickerProps, meridiemPickerProps, timeOffsetPickerProps, id } = useTimePicker({
        value,
        hourMode,
        offsets,
        isDisabled,
