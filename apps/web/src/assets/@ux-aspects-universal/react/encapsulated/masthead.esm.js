...
/** @deprecated */
const MastheadAvatar = ({ color = "plum", isInteractive = false, children }) => {
...
const MastheadTitleSecondary = forwardRef((_a, ref) => {
    var { is = "span", children } = _a, htmlProps = __rest(_a, ["is", "children"]);
...
const SecondaryMasthead = _a => {
    var { children, module, actions, tabs } = _a, props = __rest(_a, ["children", "module", "actions", "tabs"]);
