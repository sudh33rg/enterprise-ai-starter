const whiteLabel = {
    ...
    colorStatusSuccess: "#1aa364",
    colorStatusSuccessRgb: "26, 163, 100",
    colorStatusSuccessContrast: "#000",
    colorStatusSuccessContrastRgb: "0, 0, 0",
    colorStatusWarning: "#ffc002",
    colorStatusWarningRgb: "255, 192, 2",
    ...
    colorStatusInfo: "#0064ca",
    colorStatusInfoRgb: "0, 100, 202",
    ...
    colorPrimaryHover: "rgba(50, 52, 53, 0.9)",
    colorPrimaryHoverRgb: "50, 52, 53",
    colorPrimaryHoverContrast: "#fff",
    colorPrimaryHoverContrastRgb: "255, 255, 255",
    colorPrimaryActive: "rgba(50, 52, 53, 0.8)",
    colorPrimaryActiveRgb: "50, 52, 53",
    colorPrimaryActiveContrast: "#fff",
    colorPrimaryActiveContrastRgb: "255, 255, 255",
    ...
    colorPrimaryFlat: "rgba(0, 115, 231, 0.1)",
    colorPrimaryFlatHover: "rgba(0, 115, 231, 0.15)",
    colorPrimaryFlatActive: "rgba(0, 115, 231, 0.2)",
    ...
    typographyColorDisabled: "rgba(0, 0, 0, 0.2)",
    ...
    elevationBoxShadowColor1: "rgba(0, 0, 0, 0.06)",
    ...
    elevationBoxShadowColor2: "rgba(0, 0, 0, 0.1)",
    ...
    elevationBoxShadowColor3: "rgba(0, 0, 0, 0.1)",
    ...
    elevationBoxShadowColor4: "rgba(0, 0, 0, 0.12)",
    ...
    breadcrumbSeparatorColorMasthead: props => {
        return `${resolveValue(props, props.theme.breadcrumbSeparatorColor)}`;
    },
    ...
    datePickerGridCellBackgroundColorSelected: props => {
        return `rgba(${resolveValue(props, props.theme.colorBlueRgb)}, 0.1)`;
    },
    datePickerGridCellBoxShadowSelected: props => {
        return `inset 0 -0.125rem ${resolveValue(props, props.theme.colorPrimary)}`;
    },
    datePickerGridCellBoxShadowSelectionStart: props => {
        return `inset 2px 0 ${resolveValue(props, props.theme.colorPrimary)}`;
    },
    ...
    datePickerGridCellBackgroundColorSelectionBetween: props => {
        return `rgba(
    ${resolveValue(props, props.theme.colorBlueRgb)},
    0.05
  )`;
    },
    ...
    datePickerGridCellBoxShadowDisabledSelected: props => {
        return `inset 0 -0.125rem rgba(${resolveValue(props, props.theme.colorPrimaryRgb)}, 0.2)`;
    },
    ...
    loginPageBackdropBackground: "radial-gradient(\n      47.55% 72.72% at -8.26% 38.8%,\n      rgba(0, 76, 191, 1) 0%,\n      rgba(0, 76, 191, 0.1) 90%,\n      transparent 100%\n    ),\n    linear-gradient(71.92deg, rgb(1, 125, 231) 24.51%, rgb(141, 197, 234) 93.46%)",
    ...
    mastheadBorderBottomColorPrimary: props => {
        return `${resolveValue(props, props.theme.colorGray25)}`;
    },
    mastheadColorSecondary: props => {
        return `${resolveValue(props, props.theme.typographyColorBody)}`;
    },
    mastheadBackgroundSecondary: "#f9fafb",
    mastheadHeightSecondary: "48px",
    mastheadBorderBottomColorSecondary: "#eaebed",
    mastheadSeparatorWidth: "1px",
    mastheadSeparatorHeight: "16px",
    ...
    mastheadSeparatorBackgroundColor: props => {
        return `rgba(${resolveValue(props, props.theme.colorBlackRgb)}, 0.5)`;
    },
    ...
    mastheadTabBackgroundColorPrimaryHover: props => {
        return `${resolveValue(props, props.theme.colorSecondaryHover)}`;
    },
    mastheadTabBackgroundColorPrimaryActive: props => {
        return `${resolveValue(props, props.theme.colorSecondaryActive)}`;
    },
    mastheadTabBackgroundColorPrimaryFocus: props => {
        return `${resolveValue(props, props.theme.colorSecondaryFocus)}`;
    },
    ...
    mastheadActionBackgroundColorFocus: props => {
        return `${resolveValue(props, props.theme.colorSecondaryFocus)}`;
    },
    ...
    menuItemBackgroundColorSelected: props => {
        return `rgba(${resolveValue(props, props.theme.colorBlueRgb)}, 0.2)`;
    },
    ...
    tableSortToggleBackgroundColorFocused: props => {
        return `${resolveValue(props, props.theme.tableSortToggleBackgroundColorHover)}`;
    },
    ...
    toggleButtonBackgroundColorHover: props => {
        return `${resolveValue(props, props.theme.colorSecondaryFlatHover)}`;
    }
};
