...
function useTabs(children) {
    ...
    return (_a = React.Children.map(children, (child, index) => {
        const _a = child.props, { id, label, isDisabled } = _a, props = __rest(_a, ["id", "label", "isDisabled"]);
        return {
...
const TabButton = _a => {
    var { id, isActive, isDisabled, onActivate, label } = _a, props = __rest(_a, ["id", "isActive", "isDisabled", "onActivate", "label"]);
...
const TabGroup = _a => {
    var { activeId, onActiveIdChange, activeIndex, onActiveIndexChange, className, variant = "secondary", children, size = variant === "primary" ? "medium" : "small", orientation = "horizontal" } = _a, props = __rest(_a, ["activeId", "onActiveIdChange", "activeIndex", "onActiveIndexChange", "className", "variant", "children", "size", "orientation"]);
