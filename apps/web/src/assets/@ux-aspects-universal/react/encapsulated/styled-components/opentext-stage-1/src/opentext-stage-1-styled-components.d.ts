...
type StyledTheme = ThemeProps<typeof opentextStage1>;
export declare const opentextStage1: {
    colorGray95: string;
    ...
    mastheadBackgroundPrimary: string;
    ...
    mastheadTitleColor: (props: StyledTheme) => string;
    loginBrandImageWidth: string;
    loginBrandImageHeight: string;
};
export {};
