...
type StyledTheme = ThemeProps<typeof whiteLabel>;
export declare const whiteLabel: {
    colorGray95: string;
    ...
    colorPrimaryFlatHover: string;
    colorPrimaryFlatActive: string;
    ...
    mastheadBorderBottomColorPrimary: (props: StyledTheme) => string;
    mastheadColorSecondary: (props: StyledTheme) => string;
    mastheadBackgroundSecondary: string;
    ...
    toggleButtonBackgroundColorHover: (props: StyledTheme) => string;
};
export {};
