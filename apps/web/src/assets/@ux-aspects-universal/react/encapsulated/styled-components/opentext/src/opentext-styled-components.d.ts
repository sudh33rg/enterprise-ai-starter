...
type StyledTheme = ThemeProps<typeof opentext>;
export declare const opentext: {
    colorGray95: string;
    ...
    colorStatusSuccess: (props: StyledTheme) => string;
    colorStatusSuccessRgb: (props: StyledTheme) => string;
    colorStatusSuccessContrast: (props: StyledTheme) => string;
    colorStatusSuccessContrastRgb: (props: StyledTheme) => string;
    ...
    colorStatusError: (props: StyledTheme) => string;
    colorStatusErrorRgb: (props: StyledTheme) => string;
    colorStatusErrorContrast: (props: StyledTheme) => string;
    colorStatusErrorContrastRgb: (props: StyledTheme) => string;
    colorStatusInfo: (props: StyledTheme) => string;
    colorStatusInfoRgb: (props: StyledTheme) => string;
    colorStatusInfoContrast: (props: StyledTheme) => string;
    colorStatusInfoContrastRgb: (props: StyledTheme) => string;
    ...
    colorSecondary: (props: StyledTheme) => string;
    colorSecondaryRgb: (props: StyledTheme) => string;
    colorSecondaryContrast: (props: StyledTheme) => string;
    colorSecondaryContrastRgb: (props: StyledTheme) => string;
    colorSecondaryHover: (props: StyledTheme) => string;
    colorSecondaryHoverRgb: (props: StyledTheme) => string;
    colorSecondaryHoverContrast: (props: StyledTheme) => string;
    colorSecondaryHoverContrastRgb: (props: StyledTheme) => string;
    colorSecondaryActive: (props: StyledTheme) => string;
    colorSecondaryActiveRgb: (props: StyledTheme) => string;
    colorSecondaryActiveContrast: (props: StyledTheme) => string;
    colorSecondaryActiveContrastRgb: (props: StyledTheme) => string;
    ...
    typographyColorBodyRgb: string;
    typographyColorBodyContrast: string;
    typographyColorBodyContrastRgb: string;
    ...
    typographyColorLinkActive: string;
    typographyColorLinkVisited: string;
    ...
    elevationBackgroundColorBase: string;
    ...
    alertHeight: string;
    alertBorderWidth: (props: StyledTheme) => string;
    alertBorderStyle: string;
    alertBorderColor: (props: StyledTheme) => string;
    alertPaddingInline: string;
    alertPaddingBlock: string;
    alertBackgroundColorInfo: string;
    alertColorInfo: (props: StyledTheme) => string;
    alertBackgroundColorError: string;
    alertColorError: (props: StyledTheme) => string;
    alertBackgroundColorSuccess: string;
    alertColorSuccess: (props: StyledTheme) => string;
    alertBackgroundColorWarning: string;
    ...
    buttonBoxShadowSecondaryHover: (props: StyledTheme) => string;
    ...
    buttonBoxShadowSecondaryActive: (props: StyledTheme) => string;
    ...
    buttonBackgroundColorFlatPrimaryDisabled: (props: StyledTheme) => string;
    ...
    buttonBorderWidthFlatSecondary: (props: StyledTheme) => string;
    ...
    buttonBackgroundColorFlatSecondaryDisabled: (props: StyledTheme) => string;
    ...
    datePickerCalendarHeaderFontSize: (props: StyledTheme) => string;
    ...
    datePickerGridCellHeight: string;
    datePickerGridCellFontSize: (props: StyledTheme) => string;
    ...
    datePickerGridCellBackgroundColorHover: string;
    ...
    datePickerGridCellBoxShadowDisabledSelectionStart: string;
    datePickerGridCellBoxShadowDisabledSelectionEnd: string;
    ...
    dateRangePickerSummaryBorderBottom: string;
    ...
    iconButtonWidthSmall: (props: StyledTheme) => string;
    ...
    iconButtonWidthLarge: (props: StyledTheme) => string;
    ...
    iconButtonWidthExtraLarge: (props: StyledTheme) => string;
    ...
    inputGroupBorderWidth: (props: StyledTheme) => string;
    inputGroupBorderStyle: (props: StyledTheme) => string;
    ...
    inputGroupPaddingInlineStart: (props: StyledTheme) => string;
    ...
    inputGroupBorderColorDisabled: string;
    inputGroupColorDisabled: (props: StyledTheme) => string;
    inputGroupBackgroundColorDisabled: string;
    ...
    mastheadBorderBottomWidthSecondary: (props: StyledTheme) => string;
    ...
    mastheadActionBackgroundColorHover: string;
    mastheadActionBackgroundColorActive: string;
    ...
    menuMinWidth: string;
    menuFilter: (props: StyledTheme) => string;
    ...
    menuItemBackgroundColorHover: string;
    ...
    menuItemBackgroundColorSelected: string;
    ...
    popoverBackgroundColorLight: string;
    ...
    radioButtonLabelColorDisabled: string;
    ...
    splitIconButtonPaddingInline: string;
    splitIconButtonPaddingBlock: string;
    ...
    tableHeaderCellBorderColor: string;
    ...
    tableCellBackgroundColorHover: string;
    tableCellBackgroundColorSelected: string;
    ...
    textInputBorderWidth: (props: StyledTheme) => string;
    ...
    textareaPaddingBlockStart: string;
    ...
    textareaBorderWidth: (props: StyledTheme) => string;
    textareaBorderStyle: (props: StyledTheme) => string;
    ...
    toggleButtonGroupBorderRadius: string;
    ...
    toggleSwitchTrackBackgroundColor: string;
    ...
    toggleSwitchTrackBackgroundColorDisabled: string;
    ...
    toggleSwitchThumbInsetInlineEndHover: (props: StyledTheme) => string;
    ...
    toggleSwitchThumbBackgroundColorDisabled: string;
    ...
    toggleSwitchThumbBoxShadowFocused: string;
    ...
    colorNavy: string;
    colorNavyRgb: string;
    colorNavyContrast: string;
    colorNavyContrastRgb: string;
    colorTeal: string;
    colorTealRgb: string;
    colorTealContrast: string;
    colorTealContrastRgb: string;
    colorSteel: string;
    colorSteelRgb: string;
    colorSteelContrast: string;
    colorSteelContrastRgb: string;
    colorMadderRed2: string;
    colorMadderRed2Rgb: string;
    colorMadderRed2Contrast: string;
    colorMadderRed2ContrastRgb: string;
    colorLightBlue2: string;
    colorLightBlue2Rgb: string;
    colorLightBlue2Contrast: string;
    colorLightBlue2ContrastRgb: string;
    colorBurnt: string;
    colorBurntRgb: string;
    colorBurntContrast: string;
    colorBurntContrastRgb: string;
    colorNavy2: string;
    colorNavy2Rgb: string;
    colorNavy2Contrast: string;
    colorNavy2ContrastRgb: string;
    colorFirebrick: string;
    colorFirebrickRgb: string;
    colorFirebrickContrast: string;
    colorFirebrickContrastRgb: string;
    colorPine: string;
    colorPineRgb: string;
    colorPineContrast: string;
    colorPineContrastRgb: string;
    colorGreen: string;
    colorGreenRgb: string;
    colorGreenContrast: string;
    colorGreenContrastRgb: string;
    colorCerulean2: string;
    colorCerulean2Rgb: string;
    colorCerulean2Contrast: string;
    colorCerulean2ContrastRgb: string;
    colorLake: string;
    colorLakeRgb: string;
    colorLakeContrast: string;
    colorLakeContrastRgb: string;
    colorDiscovery2: string;
    colorDiscovery2Rgb: string;
    colorDiscovery2Contrast: string;
    colorDiscovery2ContrastRgb: string;
    colorLake2: string;
    colorLake2Rgb: string;
    colorLake2Contrast: string;
    colorLake2ContrastRgb: string;
    colorFirebrick1: string;
    colorFirebrick1Rgb: string;
    colorFirebrick1Contrast: string;
    colorFirebrick1ContrastRgb: string;
    colorRaspberry: string;
    colorRaspberryRgb: string;
    colorRaspberryContrast: string;
    colorRaspberryContrastRgb: string;
    focusIndicatorBoxShadowSecondary: (props: StyledTheme) => string;
    alertBorderWidthTop: string;
    alertBorderWidthRight: string;
    alertBorderWidthBottom: string;
    alertBorderWidthLeft: string;
    alertBorderColorInfo: (props: StyledTheme) => string;
    alertBorderColorError: (props: StyledTheme) => string;
    alertBorderColorSuccess: (props: StyledTheme) => string;
    alertBorderColorWarning: (props: StyledTheme) => string;
    datePickerTitleFontSize: (props: StyledTheme) => string;
    datePickerTitleFontWeight: (props: StyledTheme) => string;
    datePickerGridCellBorderStartStartRadius: string;
    datePickerGridCellBorderStartEndRadius: string;
    datePickerGridCellBorderEndStartRadius: string;
    datePickerGridCellBorderEndEndRadius: string;
    datePickerGridCellBorderStartStartRadiusSelectionStart: string;
    datePickerGridCellBorderStartEndRadiusSelectionStart: string;
    datePickerGridCellBorderEndStartRadiusSelectionStart: string;
    datePickerGridCellBorderEndEndRadiusSelectionStart: string;
    datePickerGridCellBorderStartStartRadiusSelectionEnd: string;
    datePickerGridCellBorderStartEndRadiusSelectionEnd: string;
    datePickerGridCellBorderEndStartRadiusSelectionEnd: string;
    datePickerGridCellBorderEndEndRadiusSelectionEnd: string;
    datePickerGridCellBorderStartStartRadiusSelectionBetween: string;
    datePickerGridCellBorderStartEndRadiusSelectionBetween: string;
    datePickerGridCellBorderEndStartRadiusSelectionBetween: string;
    datePickerGridCellBorderEndEndRadiusSelectionBetween: string;
    formFieldFeedbackColor: (props: StyledTheme) => string;
    inputGroupBackgroundColor: string;
    loginFormActionGroupBackgroundColor: string;
    selectPaddingBlock: string;
    selectArrowSize: string;
    textInputBorderWidthTop: string;
    textInputBorderWidthRight: string;
    textInputBorderWidthBottom: string;
    textInputBorderWidthLeft: string;
};
export {};
