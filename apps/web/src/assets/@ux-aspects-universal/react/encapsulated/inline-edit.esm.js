...
const InlineEditBeginEditingButton = forwardRef((props, ref) => {
    const { size, editButtonAriaLabel, startEditing } = useInlineEditContext();
...
const InlineEditCancelButton = forwardRef((props, ref) => {
    const { size, cancel, cancelButtonAriaLabel } = useInlineEditContext();
    return React.createElement(IconButton, Object.assign({
        ref: ref
    }, mergeProps({
        flat: true,
...
const InlineEditResetButton = forwardRef((props, ref) => {
    const { size, reset, canReset, resetButtonAriaLabel } = useInlineEditContext();
    return React.createElement(IconButton, Object.assign({
        ref: ref
    }, mergeProps({
        flat: true,
...
const InlineEditSaveButton = forwardRef((props, ref) => {
    const { size, save, canSave, hasChanged, saveButtonAriaLabel } = useInlineEditContext();
    return React.createElement(IconButton, Object.assign({
        ref: ref
    }, mergeProps({
        flat: true,
