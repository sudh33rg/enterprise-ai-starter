...
const Accordion = _a => {
  var {
    ...
    props = __rest(_a, ["iconAlign", "id", "children"]);
...
const AccordionPanel = _a => {
  var {
    ...
    props = __rest(_a, ["header", "isExpanded", "onExpandedChange", "children", "defaultExpanded"]);
