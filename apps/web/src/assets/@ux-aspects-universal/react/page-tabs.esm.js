...
const PageTabButton = forwardRef((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["id", "icon", "label", "isRemovable"]);
...
const PageTabGroupList = forwardRef(({
  controller,
  children
}, ref) => {
...
const PageTabMenu = forwardRef((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["tabs", "closeMenu"]);
...
function PageTabOverflowButton({
  tabs
}) {
...
const PageTabGroup = forwardRef((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["selectedTab", "size", "onSelectedTabChange", "onTabClose", "level", "children"]);
