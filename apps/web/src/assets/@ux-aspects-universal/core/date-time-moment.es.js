import { U as Ms } from "./date-time-adapter-CdWDkLCm.mjs";
function Ds(e) {
...
function Oe(e, t) {
  return e.isValid() ? (t = Ft(t, e.localeData()), Ze[t] = Ze[t] || xs(t), Ze[t](e)) : e.localeData().invalidDate();
}
function Ft(e, t) {
  var s = 5;
  function r(a) {
...
function As(e) {
  var t = [], s;
  for (s in e)
    w(e, s) && t.push({ unit: s, priority: Es[s] });
  return t.sort(function(r, a) {
    return r.priority - a.priority;
  }), t;
}
var Ct = /\d/, b = /\d\d/, Lt = /\d{3}/, lt = /\d{4}/, Ce = /[+-]?\d{6}/, M = /\d\d?/, Ut = /\d\d\d\d?/, It = /\d\d\d\d\d\d?/, Le = /\d{1,3}/, ut = /\d{1,4}/, Ue = /[+-]?\d{1,6}/, de = /\d+/, Ie = /[+-]?\d+/, Vs = /Z|[+-]\d\d:?\d\d/gi, He = /Z|[+-]\d\d(?::?\d\d)?/gi, Gs = /[+-]?\d+(\.\d{1,3})?/, De = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, he = /^[1-9]\d?/, dt = /^([1-9]\d|\d)/, xe;
xe = {};
function d(e, t, s) {
...
var p = 0, G = 1, L = 2, Y = 3, P = 4, j = 5, te = 6, $s = 7, qs = 8;
h("Y", 0, 0, function() {
  var e = this.year();
...
var Ks = "January_February_March_April_May_June_July_August_September_October_November_December".split(
  "_"
), At = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), Vt = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, er = De, tr = De;
function sr(e, t) {
...
function or(e) {
  return this._monthsParseExact ? (w(this, "_monthsRegex") || zt.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (w(this, "_monthsShortRegex") || (this._monthsShortRegex = er), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
}
function lr(e) {
  return this._monthsParseExact ? (w(this, "_monthsRegex") || zt.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (w(this, "_monthsRegex") || (this._monthsRegex = tr), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
}
function zt() {
  function e(f, _) {
...
var gr = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), $t = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), kr = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), Sr = De, Mr = De, Dr = De;
function vr(e, t) {
...
function Rr(e) {
  return this._weekdaysParseExact ? (w(this, "_weekdaysRegex") || ct.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (w(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Dr), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
}
function ct() {
  function e(O, E) {
...
function Ae(e) {
  ...
  if (D[e] === void 0 && typeof module < "u" && module && module.exports && Ar(e))
    try {
      t = ke._abbr, s = Ds, s("./locale/" + e), K(t);
    } catch {
      D[e] = null;
    }
  return D[e];
...
function K(e, t) {
  var s;
  return e && (T(t) ? s = q(e) : s = _t(e, t), s ? ke = s : typeof console < "u" && console.warn && console.warn(
...
function yt(e) {
  var t, s = e._a;
  return s && c(e).overflow === -2 && (t = s[G] < 0 || s[G] > 11 ? G : s[L] < 1 || s[L] > ht(s[p], s[G]) ? L : s[Y] < 0 || s[Y] > 24 || s[Y] === 24 && (s[P] !== 0 || s[j] !== 0 || s[te] !== 0) ? Y : s[P] < 0 || s[P] > 59 ? P : s[j] < 0 || s[j] > 59 ? j : s[te] < 0 || s[te] > 999 ? te : -1, c(e)._overflowDayOfYear && (t < p || t > L) && (t = L), c(e)._overflowWeeks && t === -1 && (t = $s), c(e)._overflowWeekday && t === -1 && (t = qs), c(e).overflow = t), e;
}
var jr = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/, zr = /^\s*((?:[+-]\d{6}|\d{4})(?:\d\d\d\d|W\d\d\d|W\d\d|\d\d\d|\d\d|))(?:(T| )(\d\d(?:\d\d(?:\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/, Zr = /Z|[+-]\d\d(?::?\d\d)?/, pe = [
  ...
  ["HHmm", /\d\d\d\d/],
  ["HH", /\d\d/]
], $r = /^\/?Date\((-?\d+)/i, qr = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/, Br = {
  UT: 0,
  GMT: 0,
  EDT: -4 * 60,
  EST: -5 * 60,
...
function Qt(e) {
  var t, s, r = e._i, a = jr.exec(r) || zr.exec(r), n, i, u, f, _ = pe.length, O = $e.length;
  if (a) {
...
function Xt(e) {
  ...
  if (t) {
    if (s = Jr(
      ...
      return;
    e._a = s, e._tzm = ea(t[8], t[9], t[10]), e._d = we.apply(null, e._a), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), c(e).rfc2822 = !0;
  } else
    e._isValid = !1;
}
function ta(e) {
...
function wt(e) {
  var t, s, r = [], a, n, i;
  if (!e._d) {
    for (a = sa(e), e._w && e._a[L] == null && e._a[G] == null && ra(e), e._dayOfYear != null && (i = ne(e._a[p], a[p]), (e._dayOfYear > _e(i) || e._dayOfYear === 0) && (c(e)._overflowDayOfYear = !0), s = we(i, 0, e._dayOfYear), e._a[G] = s.getUTCMonth(), e._a[L] = s.getUTCDate()), t = 0; t < 3 && e._a[t] == null; ++t)
      e._a[t] = r[t] = a[t];
    for (; t < 7; t++)
      e._a[t] = r[t] = e._a[t] == null ? t === 2 ? 1 : 0 : e._a[t];
    e._a[Y] === 24 && e._a[P] === 0 && e._a[j] === 0 && e._a[te] === 0 && (e._nextDay = !0, e._a[Y] = 0), e._d = (e._useUTC ? we : ur).apply(
      null,
      r
...
function gt(e) {
  ...
  c(e).charsLeftOver = u - f, t.length > 0 && c(e).unusedInput.push(t), e._a[Y] <= 12 && c(e).bigHour === !0 && e._a[Y] > 0 && (c(e).bigHour = void 0), c(e).parsedDateParts = e._a.slice(0), c(e).meridiem = e._meridiem, e._a[Y] = aa(
    e._locale,
    e._a[Y],
    e._meridiem
...
function oa(e) {
  var t = new Me(yt(Kt(e)));
  return t._nextDay && (t.add(1, "d"), t._nextDay = void 0), t;
}
function Kt(e) {
  var t = e._i, s = e._f;
  return e._locale = e._locale || q(e._l), t === null || s === void 0 && t === "" ? Fe({ nullInput: !0 }) : (typeof t == "string" && (e._i = t = e._locale.preparse(t)), F(t) ? new Me(yt(t)) : (Se(t) ? e._d = t : R(s) ? na(e) : s ? gt(e) : la(e), rt(e) || (e._d = null), e));
}
function la(e) {
  var t = e._i;
  T(t) ? e._d = new Date(l.now()) : Se(t) ? e._d = new Date(t.valueOf()) : typeof t == "string" ? ta(e) : R(t) ? (e._a = Wt(t.slice(0), function(s) {
    return parseInt(s, 10);
  }), wt(e)) : se(t) ? ia(e) : $(t) ? e._d = new Date(t) : l.createFromInputFallback(e);
}
function es(e, t, s, r, a) {
  var n = {};
  return (t === !0 || t === !1) && (r = t, t = void 0), (s === !0 || s === !1) && (r = s, s = void 0), (se(e) && st(e) || R(e) && e.length === 0) && (e = void 0), n._isAMomentObject = !0, n._useUTC = n._isUTC = a, n._l = s, n._i = e, n._f = t, n._strict = r, oa(n);
}
function S(e, t, s, r) {
  return es(e, t, s, r, !1);
}
...
function Oa() {
  ...
  var e = {}, t;
  return at(e, this), e = Kt(e), e._a ? (t = e._isUTC ? I(e._a) : S(e._a), this._isDSTShifted = this.isValid() && wa(e._a, t.toArray()) > 0) : this._isDSTShifted = !1, this._isDSTShifted;
}
function Ta() {
...
var xa = /^(-|\+)?(?:(\d*)[. ])?(\d+):(\d+)(?::(\d+)(\.\d*)?)?$/, Na = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/;
function C(e, t) {
  ...
  return Te(e) ? s = {
    ...
    d: e._days,
    M: e._months
  } : $(e) || !isNaN(+e) ? (s = {}, t ? s[t] = +e : s.milliseconds = +e) : (r = xa.exec(e)) ? (a = r[1] === "-" ? -1 : 1, s = {
    y: 0,
    d: m(r[L]) * a,
    h: m(r[Y]) * a,
    m: m(r[P]) * a,
...
function Wa(e, t) {
  var s;
  return e.isValid() && t.isValid() ? (t = St(t, e), e.isBefore(t) ? s = bt(e, t) : (s = bt(t, e), s.milliseconds = -s.milliseconds, s.months = -s.months), s) : { milliseconds: 0, months: 0 };
}
function as(e, t) {
  return function(s, r) {
    var a, n;
...
var Pa = as(1, "add"), Ra = as(-1, "subtract");
function is(e) {
  return typeof e == "string" || e instanceof String;
}
function Fa(e) {
  return F(e) || Se(e) || is(e) || $(e) || La(e) || Ca(e) || e === null || e === void 0;
}
function Ca(e) {
...
function Ha(e, t) {
  arguments.length === 1 && (arguments[0] ? Fa(arguments[0]) ? (e = arguments[0], t = void 0) : Ua(arguments[0]) && (t = arguments[0], e = void 0) : (e = void 0, t = void 0));
  var s = e || S(), r = St(s, this).startOf("day"), a = l.calendarFormat(this, r) || "sameElse", n = t && (H(t[a]) ? t[a].call(this, s) : t[a]);
  return this.format(
...
function Xn() {
  ...
  return e >= 0 && t >= 0 && s >= 0 || e <= 0 && t <= 0 && s <= 0 || (e += xt(tt(s) + t) * 864e5, t = 0, s = 0), r.milliseconds = e % 1e3, a = x(e / 1e3), r.seconds = a % 60, n = x(a / 60), r.minutes = n % 60, i = x(n / 60), r.hours = i % 24, t += x(i / 24), f = x(ks(t)), s += f, t -= xt(tt(f)), u = x(s / 12), s %= 12, r.days = t, r.months = s, r.years = u, this;
}
function ks(e) {
...
var Ss = B("ms"), ei = B("s"), ti = B("m"), si = B("h"), ri = B("d"), ai = B("w"), ni = B("M"), ii = B("Q"), oi = B("y"), li = Ss;
function ui() {
  return C(this);
}
function di(e) {
...
var hi = re("milliseconds"), fi = re("seconds"), ci = re("minutes"), mi = re("hours"), _i = re("days"), yi = re("months"), wi = re("years");
function gi() {
...
function vi(e, t) {
  ...
  var s = !1, r = ie, a, n;
  return typeof e == "object" && (t = e, e = !1), typeof e == "boolean" && (s = e), typeof t == "object" && (r = Object.assign({}, ie, t), t.s != null && t.ss == null && (r.ss = t.s - 1)), a = this.localeData(), n = Si(this, !s, r, a), s && (n = a.pastFuture(+this, n)), a.postformat(n);
}
var qe = Math.abs;
function ae(e) {
  return (e > 0) - (e < 0) || +e;
...
class pi extends Ms {
  ...
  isSameYear(t, s) {
    return t.isSame(s, "year");
  }
  isSameMonth(t, s) {
    return t.isSame(s, "month");
  }
  isSameDate(t, s) {
    return t.isSame(s, "day");
  }
  isSameHour(t, s) {
    return t.isSame(s, "hour");
  }
  isSameMinute(t, s) {
    return t.isSame(s, "minute");
  }
  isSameSecond(t, s) {
    return t.isSame(s, "second");
  }
  getIntervalInDays(t, s) {
    return s.diff(t, "days");
  }
  create(t, s, r, a, n, i, u) {
    return l({ year: t, month: s, date: r, hour: a, minute: n, second: i, millisecond: u });
  }
  now() {
    return l();
  }
  ...
  set(t, s) {
    return t.clone().set(s);
  }
  add(t, s) {
    return t.clone().add(s);
  }
  subtract(t, s) {
    return t.clone().subtract(s);
  }
  compare(t, s) {
  ...
  getMonthNames(t) {
    return l.localeData(t?.locale()).months();
  }
  getMonthShortNames(t) {
    return l.localeData(t?.locale()).monthsShort();
  }
  getMonths(t) {
    const s = this.getMonthNames(t), r = this.getMonthShortNames(t);
    return s.map((a, n) => ({ value: n, name: a, shortName: r[n] }));
  }
  getWeekDayNames(t) {
    return l.localeData(t?.locale()).weekdays();
  }
  getWeekDayShortNames(t) {
    return l.localeData(t?.locale()).weekdaysShort();
  }
  getWeekDayNarrowNames(t) {
    return l.localeData(t?.locale()).weekdaysMin();
  }
  getMeridiemNames(t) {
    const s = l.localeData(t?.locale());
    return [s.meridiem(0, 0, !1), s.meridiem(12, 0, !1)];
  }
  setDefaultLocale(t) {
    l.locale(t);
  }
...
export {
  pi as UxaMomentDateTimeAdapter
};
