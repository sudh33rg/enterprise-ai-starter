import { U as zn } from "./date-time-adapter-CdWDkLCm.mjs";
...
const c = "numeric", C = "short", I = "long", Me = {
  year: c,
  month: c,
  day: c
}, Lt = {
...
function Jn(n, e) {
  ...
  for (let s = 0; s < t.length; s++) {
    const { type: i, value: a } = t[s], o = Gn[i];
...
class $ extends de {
  ...
  offset(e) {
    ...
    const r = Pn(this.name);
    let [s, i, a, o, u, l, f] = r.formatToParts ? Jn(r, t) : _n(r, t);
    o === "BC" && (s = -Math.abs(s) + 1);
    const T = be({
      year: s,
      month: i,
    ...
    let h = +t;
    const N = h % 1e3;
    return h -= N >= 0 ? N : 1e3 + N, (T - h) / (60 * 1e3);
  }
  /** @override **/
  equals(e) {
...
function jn(n, e = {}) {
  const t = JSON.stringify([n, e]);
  let r = Pe[t];
  return r || (r = new Intl.NumberFormat(n, e), Pe[t] = r), r;
}
let Ge = {};
function Qn(n, e = {}) {
  const { base: t, ...r } = e, s = JSON.stringify([n, r]);
  let i = Ge[s];
  return i || (i = new Intl.RelativeTimeFormat(n, e), Ge[s] = i), i;
}
let le = null;
function Kn() {
...
function Xn(n) {
  ...
  if (!e) {
    ...
    e = "getWeekInfo" in t ? t.getWeekInfo() : t.weekInfo, at[n] = e;
  }
  return e;
}
function er(n) {
    ...
    return [n];
  {
    let r, s;
    try {
      r = Ye(n).resolvedOptions(), s = n;
    } catch {
      const u = n.substring(0, t);
      r = Ye(u).resolvedOptions(), s = u;
    }
...
class ir {
  constructor(e, t, r) {
    ...
    if (!t || Object.keys(a).length > 0) {
      ...
      r.padTo > 0 && (o.minimumIntegerDigits = r.padTo), this.inf = jn(e, o);
    }
  }
  format(e) {
    if (this.inf) {
      ...
      const t = this.floor ? Math.floor(e) : Ke(e, 3);
...
class ar {
  constructor(e, t, r) {
    ...
    const i = { ...this.opts };
    i.timeZone = i.timeZone || s, this.dtf = Ye(t, i);
  }
  format() {
...
class or {
  constructor(e, t, r) {
    this.opts = { style: "long", ...r }, !t && on() && (this.rtf = Qn(e, r));
  }
  format(e, t) {
...
class k {
  ...
  static create(e, t, r, s, i = !1) {
    const a = e || S.defaultLocale, o = a || (i ? "en-US" : Kn()), u = t || S.defaultNumberingSystem, l = r || S.defaultOutputCalendar, f = _e(s) || S.defaultWeekSettings;
  ...
  constructor(e, t, r, s, i) {
    const [a, o, u] = er(e);
    this.locale = a, this.numberingSystem = t || o || null, this.outputCalendar = r || u || null, this.weekSettings = s, this.intl = tr(this.locale, this.numberingSystem, this.outputCalendar), this.weekdaysCache = { format: {}, standalone: {} }, this.monthsCache = { format: {}, standalone: {} }, this.meridiemCache = null, this.eraCache = {}, this.specifiedLocale = i, this.fastNumbersCached = null;
  }
  get fastNumbers() {
    return this.fastNumbersCached == null && (this.fastNumbersCached = sr(this)), this.fastNumbersCached;
  }
  listingMode() {
  ...
  clone(e) {
    return !e || Object.getOwnPropertyNames(e).length === 0 ? this : k.create(
      ...
      _e(e.weekSettings) || this.weekSettings,
      e.defaultToEN || !1
    );
  }
  redefaultToEN(e = {}) {
  ...
  months(e, t = !1) {
    return we(this, e, dn, () => {
      ...
      return this.monthsCache[s][e] || (this.monthsCache[s][e] = nr((i) => this.extract(i, r, "month"))), this.monthsCache[s][e];
    });
  }
  weekdays(e, t = !1) {
    return we(this, e, yn, () => {
      const r = t ? { weekday: e, year: "numeric", month: "long", day: "numeric" } : { weekday: e }, s = t ? "format" : "standalone";
      return this.weekdaysCache[s][e] || (this.weekdaysCache[s][e] = rr(
  ...
  dtFormatter(e, t = {}) {
    return new ar(e, this.intl, t);
  }
  relFormatter(e = {}) {
    return new or(this.intl, this.isEnglish(), e);
  }
  listFormatter(e = {}) {
    return Bn(this.intl, e);
  }
  isEnglish() {
    return this.locale === "en" || this.locale.toLowerCase() === "en-us" || new Intl.DateTimeFormat(this.intl).resolvedOptions().locale.startsWith("en-us");
  }
  getWeekSettings() {
    return this.weekSettings ? this.weekSettings : un() ? Xn(this.locale) : ur;
  }
  getStartOfWeek() {
...
function R(n, e) {
  ...
  if (dr(n)) {
    ...
    return t === "default" ? e : t === "local" || t === "system" ? Ee.instance : t === "utc" || t === "gmt" ? v.utcInstance : v.parseSpecifier(t) || $.create(n);
  } else return P(n) ? v.instance(n) : typeof n == "object" && "offset" in n && typeof n.offset == "function" ? n : new lr(n);
}
let ot = () => Date.now(), ut = "system", lt = null, ct = null, ft = null, dt = 60, ht, mt = null;
class S {
  /**
...
function nn(n, e, t) {
  return t + (he(n) ? tn : en)[e - 1];
}
function rn(n, e) {
  const t = he(n) ? tn : en, r = t.findIndex((i) => i < e), s = e - t[r];
...
function ve(n, e = 4, t = 1) {
  const { year: r, month: s, day: i } = n, a = nn(r, s, i), o = je(Be(r, s, i), t);
  let u = Math.floor((a - o + 14 - e) / 7), l;
  return u < 1 ? (l = r - 1, u = fe(l, e, t)) : u > fe(r, e, t) ? (l = r + 1, u = 1) : l = r, { weekYear: l, weekNumber: u, weekday: o, ...Ve(n) };
}
function yt(n, e = 4, t = 1) {
  const { weekYear: r, weekNumber: s, weekday: i } = n, a = je(Be(r, 1, e), t), o = K(r);
  let u = s * 7 + i - a - 7 + e, l;
...
function fr(n) {
  const e = xe(n.year), t = b(n.ordinal, 1, K(n.year));
  return e ? t ? !1 : x("ordinal", n.ordinal) : x("year", n.year);
}
function sn(n) {
  const e = xe(n.year), t = b(n.month, 1, 12), r = b(n.day, 1, De(n.year, n.month));
...
function De(n, e) {
  const t = gr(e - 1, 12) + 1, r = n + (e - t) / 12;
  return t === 2 ? he(r) ? 29 : 28 : [31, null, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][t - 1];
}
function be(n) {
  let e = Date.UTC(
    n.year,
...
function Tt(n, e, t) {
  return -je(Be(n, 1, e), t) + e - 1;
}
function fe(n, e = 4, t = 1) {
  const r = Tt(n, e, t), s = Tt(n + 1, e, t);
  return (K(n) - r + s) / 7;
}
function Je(n) {
...
const hn = [
  ...
  "Saturday",
  "Sunday"
], mn = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], Tr = ["M", "T", "W", "T", "F", "S", "S"];
function yn(n) {
  switch (n) {
    case "narrow":
      return [...Tr];
...
const gn = ["AM", "PM"], Sr = ["Before Christ", "Anno Domini"], pr = ["BC", "AD"], Or = ["B", "A"];
function wn(n) {
  switch (n) {
    case "narrow":
      return [...Or];
...
class M {
  ...
  formatDateTimeFromString(e, t) {
    const r = this.loc.listingMode() === "en", s = this.loc.outputCalendar && this.loc.outputCalendar !== "gregory", i = (h, N) => this.loc.extract(e, h, N), a = (h) => e.isOffsetFixed && e.offset === 0 && h.allowZ ? "Z" : e.isValid ? e.zone.formatOffset(e.ts, h.format) : "", o = () => r ? Nr(e) : i({ hour: "numeric", hourCycle: "h12" }, "dayperiod"), u = (h, N) => r ? vr(e, h) : i(N ? { month: h } : { month: h, day: "numeric" }, "month"), l = (h, N) => r ? Mr(e, h) : i(
      N ? { weekday: h } : { weekday: h, month: "long", day: "numeric" },
      "weekday"
    ), f = (h) => {
      const N = M.macroTokenToFormatOpts(h);
      return N ? this.formatWithSystemDefault(e, N) : h;
    }, y = (h) => r ? Dr(e, h) : i({ era: h }, "era"), T = (h) => {
      switch (h) {
        // ms
        case "S":
...
const Sn = /(?:(Z)|([+-]\d\d)(?::?(\d\d))?)/, xr = `(?:${Sn.source}?(?:\\[(${kn.source})\\])?)?`, Xe = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/, pn = RegExp(`${Xe.source}${xr}`), et = RegExp(`(?:T${pn.source})?`), br = /([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/, Fr = /(\d{4})-?W(\d\d)(?:-?(\d))?/, Vr = /(\d{4})-?(\d{3})/, Wr = Tn("weekYear", "weekNumber", "weekDay"), Cr = Tn("year", "ordinal"), Lr = /(\d{4})-(\d\d)-(\d\d)/, On = RegExp(
  `${Xe.source} ?(?:${Sn.source}|(${kn.source}))?`
), Zr = RegExp(`(?: ${On.source})?`);
function X(n, e, t) {
  const r = n[e];
  return m(r) ? t : U(r);
...
function se(n, e) {
  return [{
    ...
    minutes: X(n, e + 1, 0),
    seconds: X(n, e + 2, 0),
    milliseconds: Qe(n[e + 3])
  }, null, e + 4];
}
function me(n, e) {
  const t = !n[e] && !n[e + 1], r = Fe(n[e + 1], n[e + 2]), s = t ? null : v.instance(r);
  return [{}, s, e + 3];
}
function ye(n, e) {
...
const Ar = RegExp(`^T?${Xe.source}$`), zr = /^-?P(?:(?:(-?\d{1,20}(?:\.\d{1,20})?)Y)?(?:(-?\d{1,20}(?:\.\d{1,20})?)M)?(?:(-?\d{1,20}(?:\.\d{1,20})?)W)?(?:(-?\d{1,20}(?:\.\d{1,20})?)D)?(?:T(?:(-?\d{1,20}(?:\.\d{1,20})?)H)?(?:(-?\d{1,20}(?:\.\d{1,20})?)M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,20}))?S)?)?)$/;
function Ur(n) {
  const [e, t, r, s, i, a, o, u, l] = n, f = e[0] === "-", y = u && u[0] === "-", T = (h, N = !1) => h !== void 0 && (N || h && f) ? -h : h;
  return [
    {
      years: T(H(t)),
      months: T(H(r)),
...
function tt(n, e, t, r, s, i, a) {
  ...
  return a && (o.second = U(a)), n && (o.weekday = n.length > 3 ? hn.indexOf(n) + 1 : mn.indexOf(n) + 1), o;
}
...
function qr(n) {
  const [
    ...
    f,
    y
  ] = n, T = tt(e, s, r, t, i, a, o);
  let h;
  return u ? h = Rr[u] : l ? h = 0 : h = Fe(f, y), [T, new v(h)];
}
function Yr(n) {
...
function pt(n) {
  ...
  return [tt(e, s, r, t, i, a, o), v.utcInstance];
}
function Jr(n) {
  const [, e, t, r, s, i, a, o] = n;
  return [tt(e, o, t, r, s, i, a), v.utcInstance];
}
const Br = te(br, et), jr = te(Fr, et), Qr = te(Vr, et), Kr = te(pn), Nn = ne(
  $r,
  se,
  me,
  ye
...
const us = te(Lr, Zr), ls = te(On), cs = ne(
  se,
  me,
  ye
);
...
class g {
  ...
  toFormat(e, t = {}) {
    ...
    return this.isValid ? M.create(this.loc, r).formatDurationFromString(this, e) : Ot;
  }
  /**
  ...
  toISO() {
    ...
    let e = "P";
    return this.years !== 0 && (e += this.years + "Y"), (this.months !== 0 || this.quarters !== 0) && (e += this.months + this.quarters * 3 + "M"), this.weeks !== 0 && (e += this.weeks + "W"), this.days !== 0 && (e += this.days + "D"), (this.hours !== 0 || this.minutes !== 0 || this.seconds !== 0 || this.milliseconds !== 0) && (e += "T"), this.hours !== 0 && (e += this.hours + "H"), this.minutes !== 0 && (e += this.minutes + "M"), (this.seconds !== 0 || this.milliseconds !== 0) && (e += Ke(this.seconds + this.milliseconds / 1e3, 3) + "S"), e === "P" && (e += "T0S"), e;
  }
  /**
   ...
   */
  toMillis() {
    return this.isValid ? vn(this.matrix, this.values) : NaN;
  }
  /**
  ...
  set(e) {
    if (!this.isValid) return this;
    const t = { ...this.values, ...Ie(e, g.normalizeUnit) };
  ...
  normalize() {
    ...
    return Nt(this.matrix, e), z(this, { values: e }, !0);
  }
  /**
  ...
  shiftTo(...e) {
    ...
    return Nt(this.matrix, t), z(this, { values: t }, !0);
  }
  /**
...
class p {
  ...
  static xor(e) {
    ...
    for (const u of o)
      r += u.type === "s" ? 1 : -1, r === 1 ? t = u.time : (t && +t != +u.time && s.push(p.fromDateTimes(t, u.time)), t = null);
    return p.merge(s);
  }
  /**
...
function F({ numberingSystem: n }, e = "") {
  return new RegExp(`${nt[n || "latn"]}${e}`);
}
const ps = "missing Intl.DateTimeFormat.formatToParts support";
function w(n, e = (t) => t) {
  return { regex: n, deser: ([t]) => e(Ss(t)) };
}
const Os = " ", Dn = `[ ${Os}]`, In = new RegExp(Dn, "g");
function Ns(n) {
  return n.replace(/\./g, "\\.?").replace(In, Dn);
}
function Dt(n) {
  return n.replace(/\./g, "").replace(In, " ").toLowerCase();
}
function V(n, e) {
  return n === null ? null : {
    regex: RegExp(n.map(Ns).join("|")),
...
function vs(n, e) {
  const t = F(e), r = F(e, "{2}"), s = F(e, "{3}"), i = F(e, "{4}"), a = F(e, "{6}"), o = F(e, "{1,2}"), u = F(e, "{1,3}"), l = F(e, "{1,6}"), f = F(e, "{1,9}"), y = F(e, "{2,4}"), T = F(e, "{4,6}"), h = (L) => ({ regex: RegExp(Ms(L.val)), deser: ([J]) => J, literal: !0 }), _ = ((L) => {
    if (n.literal)
      return h(L);
    switch (L.val) {
      // era
      ...
      case "Z":
      case "ZZ":
        return It(new RegExp(`([+-]${o.source})(?::(${r.source}))?`), 2);
      case "ZZZ":
        return It(new RegExp(`([+-]${o.source})(${r.source})?`), 2);
...
function bs(n) {
  ...
  let t = null, r;
  return m(n.z) || (t = $.create(n.z)), m(n.Z) || (t || (t = new v(n.Z)), r = n.Z), m(n.q) || (n.M = (n.q - 1) * 3 + 1), m(n.h) || (n.h < 12 && n.a === 1 ? n.h += 12 : n.h === 12 && n.a === 0 && (n.h = 0)), n.G === 0 && n.y && (n.y = -n.y), m(n.u) || (n.S = Qe(n.u)), [Object.keys(n).reduce((i, a) => {
    const o = e(a);
    return o && (i[o] = n[a]), i;
  }, {}), t, r];
}
let $e = null;
function Fs() {
  return $e || ($e = d.fromMillis(1555555555555)), $e;
}
function Vs(n, e) {
  if (n.literal)
    return n;
  const t = M.macroTokenToFormatOpts(n.val), r = bn(t, e);
  return r == null || r.includes(void 0) ? n : r;
}
function En(n, e) {
  return Array.prototype.concat(...n.map((t) => Vs(t, e)));
}
function xn(n, e, t) {
  const r = En(M.parseFormat(t), n), s = r.map((a) => vs(a, n)), i = s.find((a) => a.invalidReason);
  if (i)
    return { input: e, tokens: r, invalidReason: i.invalidReason };
  {
    const [a, o] = Es(s), u = RegExp(a, "i"), [l, f] = xs(e, u, o), [y, T, h] = f ? bs(f) : [null, null, void 0];
    if (ee(f, "a") && ee(f, "H"))
      throw new Q(
        "Can't include meridiem when specifying 24-hour format"
      );
    return { input: e, tokens: r, regex: u, rawMatches: l, matches: f, result: y, zone: T, specificOffset: h };
  }
}
function Ws(n, e, t) {
...
function bn(n, e) {
  if (!n)
    return null;
  const r = M.create(e, n).dtFormatter(Fs()), s = r.formatToParts(), i = r.resolvedOptions();
  return s.map((a) => Is(a, n, i));
}
const Ae = "Invalid DateTime", Cs = 864e13;
function Te(n) {
...
function pe(n, e, t = !0) {
  return n.isValid ? M.create(k.create("en-US"), {
    allowZ: t,
    forceSimple: !0
...
const Vn = {
  ...
  second: 0,
  millisecond: 0
}, Wn = ["year", "month", "day", "hour", "minute", "second", "millisecond"], $s = [
  "weekYear",
  "weekNumber",
  "weekday",
  "hour",
...
function Ft(n, e) {
  const t = R(e.zone, S.defaultZone), r = k.fromObject(e), s = S.now();
  let i, a;
  if (m(n.year))
    i = s;
  else {
  ...
  return new d({ ts: i, zone: t, loc: r, o: a });
}
function Vt(n, e, t) {
  const r = m(t.round) ? !0 : t.round, s = (a, o) => (a = Ke(a, r || t.calendary ? 0 : 2, !0), e.loc.clone(t).relFormatter(t).format(a, o)), i = (a) => t.calendary ? e.hasSame(n, a) ? 0 : e.startOf(a).diff(n.startOf(a), a).get(a) : e.diff(n, a).get(a);
  if (t.unit)
...
class d {
  ...
  constructor(e) {
    ...
    let r = e.invalid || (Number.isNaN(e.ts) ? new W("invalid input") : null) || (t.isValid ? null : Te(t));
    ...
    if (!r)
      if (e.old && e.old.ts === this.ts && e.old.zone.equals(t))
        ...
        s = Se(this.ts, o), r = Number.isNaN(s.year) ? new W("invalid input") : null, s = r ? null : s, i = r ? null : o;
      }
   ...
   */
  static local() {
    const [e, t] = Wt(arguments), [r, s, i, a, o, u, l] = t;
  ...
  static utc() {
    const [e, t] = Wt(arguments), [r, s, i, a, o, u, l] = t;
    return e.zone = v.utcInstance, Ft({ year: r, month: s, day: i, hour: a, minute: o, second: u, millisecond: l }, e);
  }
  /**
  ...
  static fromJSDate(e, t = {}) {
    const r = hr(e) ? e.valueOf() : NaN;
    if (Number.isNaN(r))
      return d.invalid("invalid input");
    const s = R(t.zone, S.defaultZone);
  ...
  static fromMillis(e, t = {}) {
    if (P(e))
      return e < -864e13 || e > Cs ? d.invalid("Timestamp out of range") : new d({
        ts: e,
        zone: R(t.zone, S.defaultZone),
        loc: k.fromObject(t)
      });
    throw new D(
  ...
  static fromObject(e, t = {}) {
    e = e || {};
    const r = R(t.zone, S.defaultZone);
    if (!r.isValid)
      return d.invalid(Te(r));
    const s = k.fromObject(t), i = Ie(e, bt), { minDaysInFirstWeek: a, startOfWeek: o } = wt(i, s), u = S.now(), l = m(t.specificOffset) ? r.offset(u) : t.specificOffset, f = !m(i.ordinal), y = !m(i.year), T = !m(i.month) || !m(i.day), h = y || T, N = i.weekYear || i.weekNumber;
    if ((h || f) && N)
      throw new Q(
    ...
    const _ = N || i.weekday && !h;
    let L, J, ie = Se(u, l);
    _ ? (L = $s, J = Ls, ie = ve(ie, a, o)) : f ? (L = As, J = Zs, ie = Ze(ie)) : (L = Wn, J = Vn);
    let rt = !1;
    for (const ae of L) {
      const An = i[ae];
      m(An) ? rt ? i[ae] = J[ae] : i[ae] = ie[ae] : rt = !0;
    }
    const Cn = _ ? cr(i, a, o) : f ? fr(i) : sn(i), st = Cn || an(i);
    if (st)
      return d.invalid(st);
    const Ln = _ ? yt(i, a, o) : f ? gt(i) : i, [Zn, $n] = Ne(Ln, l, r), We = new d({
      ts: Zn,
      zone: r,
      o: $n,
      loc: s
    });
    return i.weekday && h && e.weekday !== We.weekday ? d.invalid(
      "mismatched weekday",
      `you can't specify both a weekday of ${i.weekday} and a date of ${We.toISO()}`
    ) : We;
  }
  /**
  ...
  static fromFormat(e, t, r = {}) {
    ...
    return f ? d.invalid(f) : oe(o, u, r, `format ${t}`, e, l);
  }
  /**
  ...
  static expandFormat(e, t = {}) {
    return En(M.parseFormat(e), k.fromObject(t)).map((s) => s.val).join("");
  }
  // INFO
  /**
   * Get the value of unit.
   ...
   */
  get monthShort() {
    return this.isValid ? Z.months("short", { locObj: this.loc })[this.month - 1] : null;
  }
  /**
   ...
   */
  get monthLong() {
    return this.isValid ? Z.months("long", { locObj: this.loc })[this.month - 1] : null;
  }
  /**
   ...
   */
  get weekdayShort() {
    return this.isValid ? Z.weekdays("short", { locObj: this.loc })[this.weekday - 1] : null;
  }
  /**
   ...
   */
  get weekdayLong() {
    return this.isValid ? Z.weekdays("long", { locObj: this.loc })[this.weekday - 1] : null;
  }
  /**
  ...
  resolvedLocaleOptions(e = {}) {
    const { locale: t, numberingSystem: r, calendar: s } = M.create(
      this.loc.clone(e),
      e
  ...
  setZone(e, { keepLocalTime: t = !1, keepCalendarTime: r = !1 } = {}) {
    if (e = R(e, S.defaultZone), e.equals(this.zone))
      return this;
    if (e.isValid) {
      let s = this.ts;
      if (t || r) {
  ...
  set(e) {
    if (!this.isValid) return this;
    const t = Ie(e, bt), { minDaysInFirstWeek: r, startOfWeek: s } = wt(t, this.loc), i = !m(t.weekYear) || !m(t.weekNumber) || !m(t.weekday), a = !m(t.ordinal), o = !m(t.year), u = !m(t.month) || !m(t.day), l = o || u, f = t.weekYear || t.weekNumber;
    if ((l || a) && f)
      throw new Q(
        "Can't mix weekYear/weekNumber units with year/month/day or ordinals"
      );
    ...
    i ? y = yt(
      ...
      r,
      s
    ) : m(t.ordinal) ? (y = { ...this.toObject(), ...t }, m(t.day) && (y.day = Math.min(De(y.year, y.month), y.day))) : y = gt({ ...Ze(this.c), ...t });
    const [T, h] = Ne(y, this.o, this.zone);
    return q(this, { ts: T, o: h });
  }
  /**
   ...
   */
  toFormat(e, t = {}) {
    return this.isValid ? M.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e) : Ae;
  }
  /**
  ...
  diff(e, t = "milliseconds", r = {}) {
    ...
    const s = { locale: this.locale, numberingSystem: this.numberingSystem, ...r }, i = mr(t).map(g.normalizeUnit), a = e.valueOf() > this.valueOf(), o = a ? this : e, u = a ? e : this, l = ks(o, u, i, s);
    return a ? l.negate() : l;
  }
  /**
  ...
  toRelativeCalendar(e = {}) {
    return this.isValid ? Vt(e.base || d.fromObject({}, { zone: this.zone }), this, {
      ...e,
      numeric: "auto",
...
class Rs extends zn {
  ...
  isSameYear(e, t) {
    return e.hasSame(t, "year");
  }
  isSameMonth(e, t) {
    return e.hasSame(t, "month");
  }
  isSameDate(e, t) {
    return e.hasSame(t, "day");
  }
  isSameHour(e, t) {
    return e.hasSame(t, "hour");
  }
  isSameMinute(e, t) {
    return e.hasSame(t, "minute");
  }
  isSameSecond(e, t) {
    return e.hasSame(t, "second");
  }
  getIntervalInDays(e, t) {
    return Math.round(t.diff(e, "days").days);
  }
  create(e, t, r, s = 0, i = 0, a = 0, o = 0) {
    return d.utc(e, t, r, s, i, a, o);
  }
  now() {
    return d.local();
  }
  ...
  set(e, t) {
    ...
    return t.offset !== void 0 ? r.setZone(v.instance(t.offset), { keepLocalTime: !0 }) : r;
  }
  add(e, t) {
    return e.plus(t);
  }
  ...
  parse(e, t) {
    return t ? d.fromFormat(e, t) : d.fromISO(e);
  }
  format(e, t) {
    return t ? e.toFormat(t) : e.toISO();
  }
  getDateString(e) {
    return e.toLocaleString(d.DATE_MED);
  }
  getTimeString(e, t) {
    return e.toLocaleString({ ...d.TIME_WITH_SECONDS, hour12: t?.hour12 });
  }
  getMonthNames(e) {
    const t = (/* @__PURE__ */ new Date()).getFullYear(), r = new Intl.DateTimeFormat(
      e?.locale ?? S.defaultLocale ?? void 0,
      {
        month: "long"
      }
    );
    return Array.from({ length: 12 }, (s, i) => r.format(new Date(t, i, 1)));
  }
  getMonthShortNames(e) {
    return Z.months("short", { locale: e?.locale ?? void 0 });
  }
  getMonths(e) {
    const t = this.getMonthNames(e), r = this.getMonthShortNames(e);
    return t.map((s, i) => ({ value: i + 1, name: s, shortName: r[i] }));
  }
  getWeekDayNames(e) {
    return He(Z.weekdays("long", { locale: e?.locale ?? void 0 }));
  }
  getWeekDayShortNames(e) {
    return He(Z.weekdays("short", { locale: e?.locale ?? void 0 }));
  }
  getWeekDayNarrowNames(e) {
    return He(Z.weekdays("narrow", { locale: e?.locale ?? void 0 }));
  }
  getMeridiemNames(e) {
    return Z.meridiems({ locale: e?.locale ?? void 0 });
  }
  setDefaultLocale(e) {
    S.defaultLocale = e;
  }
...
function He(n) {
  return [n[6], ...n.slice(0, -1)];
}
export {
  Rs as UxaLuxonDateTimeAdapter
};
